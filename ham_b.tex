...
\end{enumerate}
\noindent\textbf{解说：}业余电台单边带话音通信SSB、低速莫尔斯电码通信CW、调频话音通信FM和残余边带业余电视VSB ATV的必要带宽分别是\textbf{3000Hz、400Hz、12.5kHz、5MH以上}。\\\noindent\textbf{答案：}C
%%%？？？
...
\begin{enumerate}[label=\Alph*), leftmargin=3em]
	...
	\item 5W
\end{enumerate}
\noindent\textbf{解说：}所属CQ分区与埃及相同的是\textbf{5A}（利比亚），与埃及同属34分区。\\其余选项为：5W（萨摩亚）所属CQ分区为32，5T（毛里塔尼亚）所属CQ分区为35，5X（乌干达）所属CQ分区为37。\\\noindent\textbf{答案：}B
