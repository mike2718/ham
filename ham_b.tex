...
\end{enumerate}
\noindent\textbf{解说：}\textbf{无线电通信是指利用无线电波进行的符号、信号、文字、图像、声音或其他信息的传输、发射或接收}。\\\noindent\textbf{答案：}C
...
\item 3000Hz、400Hz、12.5kHz、5MHz以上%5MH以上
...
\item 特高频（分米波）
\end{enumerate}
\noindent\textbf{解说：}频带2,300-2,450MHz属于无线电频谱的\textbf{特高频（分米波）}频带（波段）。\\\noindent\textbf{答案：}D
...
\item SHF
\end{enumerate}
\noindent\textbf{解说：}频带2,300-2,450MHz属于无线电频谱的\textbf{UHF}频带（波段）。\\\noindent\textbf{答案：}A
...
\item 特高频（分米波）
\end{enumerate}
\noindent\textbf{解说：}频带5.650-5.850GHz属于无线电频谱的\textbf{超高频（厘米波）}频带（波段）。\\\noindent\textbf{答案：}B
...
\item VHF
\end{enumerate}
\noindent\textbf{解说：}频带5.650-5.850GHz属于无线电频谱的\textbf{SHF}频带（波段）。\\\noindent\textbf{答案：}B
...
\item 甚高频（米波）
\end{enumerate}
\noindent\textbf{解说：}频带10-10.5GHz属于无线电频谱的\textbf{超高频（厘米波）}频带（波段）。\\\noindent\textbf{答案：}B
...
\noindent\textbf{试题：}频带10-10.5GHz属于无线电频谱的下列频带（波段）：
\begin{enumerate}[leftmargin=3em]
\item UHF
\item EHF
\item VHF
...
\item 超高频（厘米波）
\end{enumerate}
\noindent\textbf{解说：}频带241GHz-250GHz属于无线电频谱的\textbf{极高频（毫米波）}频带（波段）。\\\noindent\textbf{答案：}A
...
\item THF
\end{enumerate}
\noindent\textbf{解说：}频带241GHz-250GHz属于无线电频谱的\textbf{EHF}频带（波段）。\\\noindent\textbf{答案：}C
...
\item 低频（长波）
\end{enumerate}
\noindent\textbf{解说：}频带135.7-137.8 kHz属于无线电频谱的\textbf{低频（长波）}频带（波段）。\\\noindent\textbf{答案：}D
...
\item SLF
\end{enumerate}
\noindent\textbf{解说：}频带135.7-137.8 kHz属于无线电频谱的\textbf{LF}频带（波段）。\\\noindent\textbf{答案：}B
...
\item 甚高频（米波）
\end{enumerate}
\noindent\textbf{解说：}频带1,800kHz-2,000kHz属于无线电频谱的\textbf{中频（中波）}频带（波段）。\\\noindent\textbf{答案：}C
...
\item HF
\end{enumerate}
\noindent\textbf{解说：}频带1,800kHz-2,000kHz属于无线电频谱的\textbf{MF}频带（波段）。\\\noindent\textbf{答案：}B
...
\item 中频（中波）
\end{enumerate}
\noindent\textbf{解说：}频带28MHz-29.7MHz属于无线电频谱的\textbf{高频（短波）}频带（波段）。\\\noindent\textbf{答案：}C
...
\item LF
\end{enumerate}
\noindent\textbf{解说：}频带28MHz-29.7MHz属于无线电频谱的\textbf{HF}频带（波段）。\\\noindent\textbf{答案：}B
...
\item 特高频（分米波）
\end{enumerate}
\noindent\textbf{解说：}频带50MHz-54MHz属于无线电频谱的\textbf{甚高频（米波）}频带（波段）。\\\noindent\textbf{答案：}B
...
\item HF
\end{enumerate}
\noindent\textbf{解说：}频带50MHz-54MHz属于无线电频谱的\textbf{VHF}频带（波段）。\\\noindent\textbf{答案：}A
...
\item 衰减
\end{enumerate}
\noindent\textbf{解说：}业余无线电通信常用缩语“ABT”的意思是\textbf{关于、大约}。\\即英语About。\\\noindent\textbf{答案：}B
...
\item ADR或ADDR
\end{enumerate}
\noindent\textbf{解说：}“地址”的业余无线电通信常用缩语是\textbf{ADR或ADDR}。\\即英语Address。\\\noindent\textbf{答案：}D
...
\item 关于、大约
\end{enumerate}
\noindent\textbf{解说：}业余无线电常用缩语“ATT”的意思是\textbf{衰减}。\\即英语Attenuated。\\\noindent\textbf{答案：}C
...
\item 中继台
\end{enumerate}
\noindent\textbf{解说：}业余无线电常用缩语“PWR”的意思是\textbf{功率}。\\即英语Power。\\\noindent\textbf{答案：}A
...
\item ABV
\end{enumerate}
\noindent\textbf{解说：}“再”、“再来一次”的业余无线电通信常用缩语是\textbf{AGN}。\\即英语Again。\\\noindent\textbf{答案：}A
...
\item 姑娘
\end{enumerate}
\noindent\textbf{解说：}业余无线电通信常用缩语“GA”的意思是\textbf{继续、请过来}。\\即英语Go ahead。\\\noindent\textbf{答案：}B
...
\item 这里
\end{enumerate}
\noindent\textbf{解说：}业余无线电通信常用缩语“AHR”的意思是\textbf{另一个}。\\即英语Another。\\\noindent\textbf{答案：}A
...
\item ATN
\end{enumerate}
\noindent\textbf{解说：}“天线”的业余无线电通信常用缩语是\textbf{ANT}。\\即英语Antenna。\\\noindent\textbf{答案：}B
...
\item 天线调谐器、天调
\end{enumerate}
\noindent\textbf{解说：}业余无线电常用缩语“ARDF”的意思是\textbf{业余无线电测向}。\\即英语Amateur Radio Direction Finding。\\\noindent\textbf{答案：}B
...
\item 这里、听到
\end{enumerate}
\noindent\textbf{解说：}业余无线电常用缩语“HST”的意思是\textbf{快速收发报}。\\即英语High-speed telegraphy。\\\noindent\textbf{答案：}A
...
\item 双极型半导体管
\end{enumerate}
\noindent\textbf{解说：}业余无线电通信常用缩语“BJT”的意思是\textbf{北京时间}。\\即英语Beijing Time。\\\noindent\textbf{答案：}A
...
\item 请马上回答
\end{enumerate}
\noindent\textbf{解说：}业余无线电通信常用缩语“BK”的意思是\textbf{插入、打断}。\\即英语Break。\\\noindent\textbf{答案：}A
...
\item BRUO
\end{enumerate}
\noindent\textbf{解说：}“QSL卡片管理局”的业余无线电通信常用缩语是\textbf{BURO}。\\即英语QSL Bureau。\\\noindent\textbf{答案：}C%布若
...
\item 呼叫
\end{enumerate}
\noindent\textbf{解说：}业余无线电通信常用缩语“CFM”的意思是\textbf{确认}。\\即英语Confirm。\\\noindent\textbf{答案：}B
...
\item 呼号、清除、关闭
\end{enumerate}
\noindent\textbf{解说：}业余无线电通信常用缩语“CL”、“CLS”、“CLG”的意思分别是\textbf{关闭（或呼叫）、呼号、呼叫}。\\即英语Close, call sign, calls。\\\noindent\textbf{答案：}A
...
\item 垂直天线
\end{enumerate}
\noindent\textbf{解说：}业余无线电通信中常用的天线种类的缩写YAGI代表\textbf{八木天线}。\\即英语Yagi antenna。\\\noindent\textbf{答案：}C
...
\item 莫尔斯编码
\end{enumerate}
\noindent\textbf{解说：}业余无线电通信方式缩写CW的英文原词意义是\textbf{等幅电报}。\\即英语Continuous wave。\\\noindent\textbf{答案：}A
...
%3V字头代表\textbf{Tunisia}（突尼斯），4X字头代表\textbf{Israel}（以色列），5A字头代表\textbf{Libya}（利比亚），6Y字头代表\textbf{Jamaica}（牙买加）。
...
\end{enumerate}
\noindent\textbf{解说：}\textbf{NB为“抑噪”，切除高于平均信号的大幅度突发脉冲噪声；SQL为“静噪”，信噪比达不到一定水平时自动关闭音频输出}。\\即英语\textbf{N}oise \textbf{B}lanker和\textbf{Sq}ue\textbf{l}ch。\\\noindent\textbf{答案：}A
...
\end{enumerate}
\noindent\textbf{解说：}ALC代表\textbf{发信自动电平控制，对射频输出电平进行检测并反馈控制，以维持其在适当限度之内}。\\即英语\textbf{A}utomatic \textbf{L}evel \textbf{C}ontrol。\\\noindent\textbf{答案：}B
...
\item 自动天线调谐，对天线电路的电压驻波比进行检测并进行自动补偿，以维持最小驻波比
\end{enumerate}
\noindent\textbf{解说：}AT代表\textbf{自动天线调谐，对天线电路的电压驻波比进行检测并进行自动补偿，以维持最小驻波比}。\\即英语\textbf{A}ntenna \textbf{T}uner。\\\noindent\textbf{答案：}D
...
\item 自动天线调谐，对天线电路的电压驻波比进行检测并进行自动补偿，以维持最小驻波比
\end{enumerate}
\noindent\textbf{解说：}ATT代表\textbf{收信机输入衰减器，在接收大信号时接入，使信号不致过大而使前级电路过载}。\\即英语\textbf{Att}enuator。\\\noindent\textbf{答案：}C
...
\end{enumerate}
\noindent\textbf{解说：}AGC代表\textbf{收信机自动增益控制，对中频级信号电平进行检测并反馈控制，防止电路过载}。\\即英语\textbf{A}utomatic \textbf{G}ain \textbf{C}ontrol。\\\noindent\textbf{答案：}D
...
\item 收信机前置放大器，在接收微弱信号时接入（此时某些技术指标可能低于额定值）
\end{enumerate}
\noindent\textbf{解说：}PRE代表\textbf{收信机前置放大器，在接收微弱信号时接入（此时某些技术指标可能低于额定值）}。\\即英语\textbf{Pre}amplifier。\\\noindent\textbf{答案：}D
...
\item 收信机前置放大器，在接收微弱信号时接入（此时某些技术指标可能低于额定值）
\end{enumerate}
\noindent\textbf{解说：}PROC代表\textbf{发信语音压缩，对音频输入电平进行检测并反馈控制，以提升语音包络幅度较小的部分}。\\即英语Speech \textbf{Proc}essor。\\\noindent\textbf{答案：}C
...
\end{enumerate}
\noindent\textbf{解说：}RIT的中文名称是\textbf{接收增量调谐}，其代表的意义是\textbf{在接收频率的主调谐不变的基础上，对接收频率进行附加微调}。\\即英语\textbf{R}eceiver \textbf{I}ncremental \textbf{T}uning。\\\noindent\textbf{答案：}B
...
\item 接收增量调谐，在接收频率的主调谐不变的基础上，对接收频率进行附加微调
\end{enumerate}
\noindent\textbf{解说：}XIT的中文名称是\textbf{发射增量调谐}，其代表的意义是\textbf{在发射频率的主调谐不变的基础上，对发射频率进行附加微调}。\\即英语Transmitter Incremental Tuning。\\\noindent\textbf{答案：}C
...
\item 0.058$\times$Ｎ（安）
\item 0.091$\times$Ｎ（安）
\item 13.8 / Ｎ$\times$80\%（安）%13.8/Ｎ$\times$80\%（安）
\end{enumerate}
...
\item 200 / Ｎ$\times$80\%（安）%200/Ｎ$\times$80\%（安）
\item 220$\times$Ｎ（安）
...
\begin{enumerate}[leftmargin=3em]
\item 0.0768 / Ｎ（千瓦小时）%0.0768 /Ｎ（千瓦小时）
\item 220 / Ｎ（千瓦小时）
...
套入功率增益的计算公式得：
$$\mbox{功率增益}=10 \log \left( {\frac{P_{ \mbox{输出} }}{P_{ \mbox{输入} }}} \right)=10 \log 5 \approx 7 \ \mathrm{dB}$$
\noindent\textbf{答案：}A
...
套入功率增益的计算公式得：
$$\mbox{功率增益}=10 \log \left( {\frac{P_{ \mbox{输出} }}{P_{ \mbox{输入} }}} \right)=10 \log 2 \approx 3 \ \mathrm{dB}$$
\noindent\textbf{答案：}A
...
\begin{enumerate}[leftmargin=3em]
	...
	\item 10dB
	\item 15dB
	\item 17dB%原选项14dB？不得已改成这个以符合题目要求
\end{enumerate}
...
套入电压增益的计算公式得：
$$\mbox{电压增益}=20 \log \left( {\frac{V_{ \mbox{输出} }}{V_{ \mbox{输入} }}} \right)=20 \log 2=6 \ \mathrm{dB}$$
\noindent\textbf{答案：}C
...
\noindent\textbf{解说：}该电路的增益约为\textbf{-7dB}。\\
套入功率增益的计算公式得：
$$\mbox{功率增益}=10 \log \left( {\frac{P_{ \mbox{输出} }}{P_{ \mbox{输入} }}} \right)=10 \log \frac{1}{5}=10 \log 0.2\approx -7 \ \mathrm{dB}$$
\noindent\textbf{答案：}D
...
\noindent\textbf{解说：}该电路的增益约为\textbf{-3dB}。\\
套入功率增益的计算公式得：
$$\mbox{功率增益}=10 \log \left( {\frac{P_{ \mbox{输出} }}{P_{ \mbox{输入} }}} \right)=10 \log \frac{1}{2}=10 \log 0.5\approx -3 \ \mathrm{dB}$$
\noindent\textbf{答案：}B
...
\noindent\textbf{解说：}该电路的增益约为\textbf{-6dB}。\\
套入电压增益的计算公式得：
$$\mbox{电压增益}=20 \log \left( {\frac{V_{ \mbox{输出} }}{V_{ \mbox{输入} }}} \right)=20 \log \frac{1}{2}=20 \log 0.5\approx -6 \ \mathrm{dB}$$
\noindent\textbf{答案：}D
...
%\noindent\textbf{试题：}按照我国国家标准《电磁辐射防护规定》，凡其功率大于豁免水平（3MHz以上等效辐射功率100瓦）的一切电磁波辐射体的所有者，必须：
%\begin{enumerate}[leftmargin=3em]
...
%\noindent\textbf{试题：}按照我国国家标准《电磁辐射防护规定》，负责对超过豁免水平（3MHz以上等效辐射功率100瓦）电磁波辐射体所在的场所以及周围环境的电磁辐射水平进行监测的是：
%\begin{enumerate}[leftmargin=3em]
%\item 所在地区无线电管理机构
%\item 所在地区业余无线电协会
%\item 所在地区环境保护部门
