...
\title{\sffamily {\Huge 业余无线电操作技能考核攻略本\\（类别：B）}} %书名
...
\end{enumerate}
\noindent\textbf{解说：}我国专门针对无线电管理的最高法律文件是\textbf{《业余无线电台管理办法》}，其立法机关是\textbf{中华人民共和国工业和信息化部}。\\\noindent\textbf{答案：}A
...
\item 关于
\end{enumerate}
\noindent\textbf{解说：}业余无线电CW通信常用缩语“$\overline{AS}$”的意思是\textbf{请稍等}。\\\noindent\textbf{答案：}A
...
\item 结束通信
\end{enumerate}
\noindent\textbf{解说：}业余无线电通信常用缩语“$\overline{SK}$”的意思是\textbf{结束通信}。\\\noindent\textbf{答案：}D
...
\item 接收增量调谐，在接收频率的主调谐不变的基础上，对接收频率进行附加微调
\end{enumerate}
\noindent\textbf{解说：}XIT的中文名称是\textbf{发射增量调谐}，其代表的意义是\textbf{在发射频率的主调谐不变的基础上，对发射频率进行附加微调}。\\即英语\textbf{T}ransmitter \textbf{I}ncremental \textbf{T}uning。\\\noindent\textbf{答案：}C
...
\begin{enumerate}[label=\Alph*), leftmargin=3em]
	...
	\item 14dB
\end{enumerate}
\noindent\textbf{解说：}该电路的增益约为\textbf{15dB}。\\\noindent\textbf{答案：}C
