...
tar:
	...
	7z a -t7z -mx=9 -md=64m ..\ham_a.7z ham_a.pdf LICENSE.md README.md
	7z a -t7z -mx=9 -md=64m ..\ham_b.7z ham_b.pdf LICENSE.md README.md
#	7z a -t7z -mx=9 -md=64m ..\ham_c.7z ham_c.pdf LICENSE.md README.md
