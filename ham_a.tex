...
\begin{enumerate}[leftmargin=3em]
	...
	\item 300到3000\unit{\kHz}
	\item 30到300\unit{\MHz}
	\item 30到300\unit{\kHz}
\end{enumerate}
...
\end{enumerate}
\noindent\textbf{解说：}《中华人民共和国无线电频率划分规定》，分配给业余业务和卫星业余业务与其他业务共用、并且业余业务和卫星业余业务作为次要业务的1200\unit{\MHz}以下频段有：\textbf{135.7\unit{\kHz}、10.1\unit{\MHz}、430\unit{\MHz}}。\\\noindent\textbf{答案：}C
...
\begin{enumerate}[leftmargin=3em]
	\item 16\unit{\kHz} - 56\unit{\kHz}
	\item 16\unit{\hertz} - 20\unit{\kHz}
	\item 300\unit{\hertz} - 3000\unit{\hertz}
	\item 16\unit{\kHz} - 20\unit{\kHz}
\end{enumerate}

\noindent\textbf{解说：}音频的频率范围大致是 \textbf{16\unit{\hertz} - 20\unit{\kHz}}。\\\noindent\textbf{答案：}B
%%% 查资料得 20Hz ～ 20kHz
...
\noindent\textbf{解说：}用通常的调频方式进行话音通信，必要带宽约为\textbf{6.25\unit{\kHz}}。\\\noindent\textbf{答案：}A
%%%%
...
\begin{enumerate}[leftmargin=3em]
	\item 射频输出实际占用带宽为由电路决定的固定值，通信常用的是25\unit{\kHz}或12.5\unit{\kHz}
