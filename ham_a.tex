...
\end{enumerate}
\noindent\textbf{解说：}业余电台\texttt{BH1ZZZ}用话音发起CQ呼叫的正确格式为\texttt{\textbf{CQ、CQ、CQ。BH1ZZZ呼叫。Bravo Hotel One Zulu Zulu Zulu呼叫，BH1ZZZ呼叫。听到请回答。}}\cite{zimujieshifa}\\
\noindent\textbf{答案：}B
...
\end{enumerate}
\noindent\textbf{解说：}业余电台\texttt{BH1ZZZ}用话音发起CQ呼叫的正确格式为\texttt{\textbf{CQ CQ CQ.This is BH1ZZZ. Bravo Hotel One Zulu Zulu Zulu, BH1ZZZ is calling. I’m standing by.}}\cite{zimujieshifa}\\
\noindent\textbf{答案：}B
...
\end{enumerate}
\noindent\textbf{解说：}业余电台\texttt{BH1ZZZ}用话音呼叫\texttt{BH8YYY}的正确格式为\texttt{\textbf{BH8YYY、BH8YYY、BH8YYY。BH1ZZZ呼叫。Bravo Hotel One Zulu Zulu Zulu，BH1ZZZ呼叫。听到请回答。}}\cite{zimujieshifa}\\
\noindent\textbf{答案：}C
...
\noindent\textbf{解说：}\textbf{安（培）}是电流的单位。\cite{si}\\
\noindent\textbf{答案：}D
...
\noindent\textbf{解说：伏（特）}是电压的单位。\cite{si}\\
\noindent\textbf{答案：}B
...
\noindent\textbf{解说：欧（姆）}是电阻的单位。\cite{si}\\
\noindent\textbf{答案：}D
...
\noindent\textbf{解说：瓦（特）}是功率的单位。\cite{si}\\
\noindent\textbf{答案：}D
...
%\noindent\textbf{试题：}按照我国国家标准《电磁辐射防护规定》，凡其功率大于豁免水平（3\si{\MHz}以上等效辐射功率100瓦）的一切电磁波辐射体的所有者，必须：
%\begin{enumerate}[leftmargin=3em]
...
%\end{enumerate}
%\noindent\textbf{解说：}按照我国国家标准《电磁辐射防护规定》，凡其功率大于豁免水平（3\si{\MHz}以上等效辐射功率100瓦）的一切电磁波辐射体的所有者，必须\textbf{向所在地区的环境保护部门申报、登记，并接受监督}。\\
%\textbf{答案：}A
%
%\bigskip


%\noindent\textbf{试题：}按照我国国家标准《电磁辐射防护规定》，负责对超过豁免水平（3\si{\MHz}以上等效辐射功率100瓦）电磁波辐射体所在的场所以及周围环境的电磁辐射水平进行监测的是：
%\begin{enumerate}[leftmargin=3em]
%	\item 所在地区业余无线电协会
%	\item 所在地区无线电管理机构
%	\item 其拥有者
%	\item 所在地区环境保护部门
%\end{enumerate}
%\noindent\textbf{解说：}按照我国国家标准《电磁辐射防护规定》，\textbf{其拥有者}负责对超过豁免水平（3\si{\MHz}以上等效辐射功率100瓦）电磁波辐射体所在的场所以及周围环境的电磁辐射水平进行监测。\\\textbf{答案：}C
%
%\bigskip
