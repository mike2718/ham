...
\begin{enumerate}[leftmargin=3em]
	\item 各业余业务和卫星业余业务频段
	\item 30-3000\unit{\MHz}范围内的各业余业务和卫星业余业务频段
	\item 所有VHF和UHF频段
	\item 各VHF和UHF频段
\end{enumerate}
\noindent\textbf{解说：}《工业和信息化部关于实施〈业余无线电台管理办法〉若干事项的通知（工信部无〔2013〕43号）》第一条规定：A类业余无线电台可以在\textbf{30-3000\unit{\MHz}范围内的各业余业务和卫星业余业务频段内}发射工作，且最大发射功率不大于25瓦。\\\noindent\textbf{答案：}B
...
\begin{enumerate}[leftmargin=3em]
	...
	\item 100瓦
\end{enumerate}
\noindent\textbf{解说：}《工业和信息化部关于实施〈业余无线电台管理办法〉若干事项的通知（工信部无〔2013〕43号）》第一款规定：A类业余无线电台可以在30-1000\unit{\MHz}范围内的各业余业务和卫星业余业务频段内发射工作，且最大发射功率不大于\textbf{25瓦}。\\\noindent\textbf{答案：}C
...
\begin{enumerate}[leftmargin=3em]
	\item 千赫（或者赫兹）
	\item 绝对功率\unit[qualifier-mode=combine]{\deci\bel\of{m}}、低于载波发射功率的分贝值\unit[qualifier-mode=combine]{\deci\bel\of{c}}、低于PEP发射功率的相对值\unit{\decibel}
	\item 绝对功率（瓦）
	\item 百分之几
\end{enumerate}
\noindent\textbf{解说：}杂散域发射功率通常用\unit[qualifier-mode=combine]{\deci\bel\of{m}}、低于载波发射功率的分贝值\unit[qualifier-mode=combine]{\deci\bel\of{c}}、低于PEP发射功率的相对值\unit{\decibel}来表示。\\\noindent\textbf{答案：}B
%%%
...
\begin{enumerate}[leftmargin=3em]
	\item 300到3000\unit{\MHz}
	\item 300到3000\si{\kHz}
	\item 30到300\unit{\MHz}
	\item 30到300\si{\kHz}
\end{enumerate}
\noindent\textbf{解说：}《中华人民共和国无线电频率划分规定》第1.9款规定：VHF段的频率范围是\textbf{30到300\unit{\MHz}}。\\\noindent\textbf{答案：}C
...
\begin{enumerate}[leftmargin=3em]
	...
	\item 30到300\si{\kHz}
\end{enumerate}
\noindent\textbf{解说：}《中华人民共和国无线电频率划分规定》1.9，UHF段的频率范围是\textbf{300到3000\unit{\MHz}}。\\\noindent\textbf{答案：}C
...
\begin{enumerate}[leftmargin=3em]
	\item 3到30\unit{\MHz}
	\item 30到300\unit{\MHz}
	\item 300到3,000\unit{\MHz}
	\item 300到3,000\si{\kHz}
\end{enumerate}
\noindent\textbf{解说：}《中华人民共和国无线电频率划分规定》1.9，HF段的频率范围是\textbf{3到30\unit{\MHz}}。\\\noindent\textbf{答案：}A
...
\end{enumerate}
\noindent\textbf{解说：}《中华人民共和国无线电频率划分规定》，分配给业余业务和卫星业余业务专用的频段有：\textbf{7\unit{\MHz}、14\unit{\MHz}、21\unit{\MHz}、28\unit{\MHz}、47\unit{\GHz}频段}。\\\noindent\textbf{答案：}B
...
\end{enumerate}
\noindent\textbf{解说：}《中华人民共和国无线电频率划分规定》，分配给业余业务和卫星业余业务与其他业务共用、并且业余业务和卫星业余业务作为唯一主要业务的频段的个数以及在3\unit{\GHz}以下的该类频段分别为：\textbf{3个，144-146\unit{\MHz}}。\\\noindent\textbf{答案：}B
...
\begin{enumerate}[leftmargin=3em]
	...
	\item 135.7\si{\kHz}、10.1\unit{\MHz}、430\unit{\MHz}
	\item 10.1\unit{\MHz}、24.89\unit{\MHz}、430\unit{\MHz}
\end{enumerate}
\noindent\textbf{解说：}《中华人民共和国无线电频率划分规定》，分配给业余业务和卫星业余业务与其他业务共用、并且业余业务和卫星业余业务作为次要业务的1200\unit{\MHz}以下频段有：\textbf{135.7\si{\kHz}、10.1\unit{\MHz}、430\unit{\MHz}}。\\\noindent\textbf{答案：}C
...
\end{enumerate}
\noindent\textbf{解说：}俗称的0.7米业余波段的频率范围是\textbf{430-440\unit{\MHz}}。根据《中华人民共和国无线电频率划分规定》，在该波段中业余业务和卫星业余业务的使用状态为\textbf{次要业务}。\\\noindent\textbf{答案：}B
...
\begin{enumerate}[leftmargin=3em]
	...
	\item 固定业务
\end{enumerate}
\noindent\textbf{解说：}《中华人民共和国无线电频率划分规定》，在430-440\unit{\MHz}频段中我国分配的主要业务是\textbf{无线电定位和航空无线电导航}。\\\noindent\textbf{答案：}B
...
\end{enumerate}
\noindent\textbf{解说：}《中华人民共和国无线电频率划分规定》，VHF业余无线电台在144\unit{\MHz}频段进行本地联络时应避免占用的频率为：\textbf{144-144.035\unit{\MHz}和145.8-146\unit{\MHz}}。\\\noindent\textbf{答案：}C
...
\end{enumerate}
\noindent\textbf{解说：}《中华人民共和国无线电频率划分规定》，UHF业余无线电台在430\unit{\MHz}频段进行本地联络时应避免占用的频率为：\textbf{431.9-432.240\unit{\MHz}和435-438\unit{\MHz}}。\\\noindent\textbf{答案：}A
...
\begin{enumerate}[leftmargin=3em]
	\item 采用业余无线电标准频差，即144\unit{\MHz}频段600\si{\kHz}，430\unit{\MHz}频段5\unit{\MHz}
	\item 采用经常变换频差的办法减少占用度
	\item 尽量采用非标准频差以阻止一般业余无线电台占用
	\item 可以在国家《无线电频率划分规定》所规定业余频率范围内任意选择
\end{enumerate}
\noindent\textbf{解说：}选择144\unit{\MHz}或430\unit{\MHz}业余模拟调频中继台同频段收发频差的原则是：\textbf{采用业余无线电标准频差，即144\unit{\MHz}频段600\si{\kHz}，430\unit{\MHz}频段5\unit{\MHz}}。\\\noindent\textbf{答案：}A
%%%
...
\noindent\textbf{解说：}音频的频率范围大致是 \textbf{16Hz - 20\si{\kHz}}。\\\noindent\textbf{答案：}B
%%% 查资料得 20Hz ～ 20kHz
...
\noindent\textbf{解说：}用通常的调频方式进行话音通信，必要带宽约为\textbf{6.25\si{\kHz}}。\\\noindent\textbf{答案：}A%%%？？？
...
\noindent\textbf{解说：}以\unit[qualifier-mode=combine]{\deci\bel\of{d}}为单位的天线增益是指\textbf{最大辐射方向辐射功率密度与半波长振子最大辐射方向辐射功率密度之比的dB值}。\\\noindent\textbf{答案：}B
...
\noindent\textbf{解说：}以\unit[qualifier-mode=combine]{\deci\bel\of{i}}为单位的天线增益是指\textbf{最大辐射方向辐射功率密度与理想点源天线最大辐射方向辐射功率密度之比的dB值}。\\\noindent\textbf{答案：}A
...
\noindent\textbf{试题：}对于400\unit{\MHz}以上的信号，通常会使用的同轴电缆连接器是：
...
\noindent\textbf{解说：}对于400\unit{\MHz}以上的信号，通常会使用\textbf{N型同轴电缆连接器}。\\\noindent\textbf{答案：}A
...
\noindent\textbf{试题：}无线电波在真空中的速度大致为：（“\texttt{x\string^m}”表示“x的m次方”）
...
\begin{enumerate}[leftmargin=3em]
	...
	\item 使用300除以频率的兆赫数（\unit{\MHz}）可以得到以米为单位的波长
	\item 将频率的兆赫数（\unit{\MHz}）除以300可以得到以米为单位的波长
	\item 将频率的赫兹数（Hz）除以300可以得到以米为单位的波长
\end{enumerate}

\noindent\textbf{解说：}通过\textbf{使用300除以频率的兆赫数（\unit{\MHz}）可以得到以米为单位的波长}。\\\noindent\textbf{答案：}B
...
\noindent\textbf{解说：}《中华人民共和国无线电频率划分规定》第1.1.4款规定：\textbf{无线电波}频率规定在3000\unit{\GHz}以下，不用人造波导而在空间传播的电磁波。\\\noindent\textbf{答案：}D
...
%\end{enumerate}
%\noindent\textbf{解说：}按照我国国家标准《电磁辐射防护规定》，凡其功率大于豁免水平（3\unit{\MHz}以上等效辐射功率100瓦）的一切电磁波辐射体的所有者，必须\textbf{向所在地区的环境保护部门申报、登记，并接受监督}。\\
%\textbf{答案：}A
%
%\bigskip
...
%	\item 所在地区环境保护部门
%\end{enumerate}
%\noindent\textbf{解说：}按照我国国家标准《电磁辐射防护规定》，\textbf{其拥有者}负责对超过豁免水平（3\unit{\MHz}以上等效辐射功率100瓦）电磁波辐射体所在的场所以及周围环境的电磁辐射水平进行监测。\\\textbf{答案：}C
%
%\bigskip
...
%	\item 在发射机射频输出端口进行测量
%\end{enumerate}
%\noindent\textbf{解说：}按照我国国家标准《电磁辐射防护规定》，对超过豁免水平的电磁辐射体的环境电磁辐射水平监测应\textbf{在距辐射体天线2000米以内最大辐射方向上选点测量}。\\\textbf{答案：}A
%
%\bigskip


%\noindent\textbf{试题：}我国国家标准\textbf{《电磁辐射防护规定》}所规定的电磁辐射防护限值的公众照射基本限值，其基本计量方法是：
%\begin{enumerate}[leftmargin=3em]
...
\begin{enumerate}[leftmargin=3em]
	...
	\item 300\si{\kHz}-30\unit{\MHz}
\end{enumerate}
\noindent\textbf{解说：}我国国家标准《电磁环境控制限值》规定公众暴露控制限值中，对环境电磁辐射场强任意连续6分钟内的方均根值要求最严格的频率范围为\textbf{30\unit{\MHz}-3\unit{\GHz}}。\\
\textbf{答案：}A
