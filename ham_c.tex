...
\item 各VHF和UHF频段
\end{enumerate}
\noindent\textbf{解说：}《工业和信息化部关于实施〈业余无线电台管理办法〉若干事项的通知（工信部无〔2013〕43号）》第一条规定：C类业余无线电台可以在\textbf{各业余业务和卫星业余业务频段}内发射工作，30\unit{\MHz}以下频段最大发射功率不大于1000瓦，30\unit{\MHz}以上频段最大发射功率不大于25瓦。\\\noindent\textbf{答案：}A
...
\begin{enumerate}[leftmargin=3em]
\item 100瓦
\item 30\unit{\MHz}以下业余频段不大于1000瓦，30\unit{\MHz}以上业余频段不大于25瓦
\item 25瓦
\item 30\unit{\MHz}以上业余频段不大于1000瓦，30\unit{\MHz}以下业余频段不大于25瓦
\end{enumerate}
\noindent\textbf{解说：}《工业和信息化部关于实施〈业余无线电台管理办法〉若干事项的通知（工信部无〔2013〕43号）》第一条规定：C类业余无线电台可以在各业余业务和卫星业余业务频段内发射工作，\textbf{30\unit{\MHz}以下频段最大发射功率不大于1000瓦，30\unit{\MHz}以上频段最大发射功率不大于25瓦}。\\\noindent\textbf{答案：}B
...
\noindent\textbf{试题：}一个电容器，在50Hz频率下实测得容抗为100欧姆。按容抗公式计算，在5\unit{\MHz}时容抗应为0.001欧姆，但实测到的阻抗明显偏大。这是因为：
\begin{enumerate}[leftmargin=3em]
...
\noindent\textbf{试题：}一个电感线圈，在50Hz频率下实测得感抗为10欧姆。按感抗公式计算，在5\unit{\MHz}时感抗应为1兆欧，但实测到的阻抗明显偏小。这是因为：
\begin{enumerate}[leftmargin=3em]
...
\noindent\textbf{试题：}国际业余无线电联盟（IARU）业余无线电测向锦标赛规则要求144\unit{\MHz}测向发射机采用调幅度为70%-80%的A2A调制方式发射8-15WPM的音频摩尔斯电码发射电台标识。该类发射占用带宽不得大于下列数值：
\begin{enumerate}[leftmargin=3em]
\item 6\unit{\kHz}
\item 12.5\unit{\kHz}
\item 25\unit{\kHz}
...
\begin{enumerate}[leftmargin=3em]
\item 输出信号达到一定质量标准时输入信号的最小功率电平，单位\unit[qualifier-mode=combine]{\deci\bel\of{m}}或\unit[qualifier-mode=combine]{\deci\bel\of{μ}}W
...
\begin{enumerate}[leftmargin=3em]
\item 输出信号达到一定质量标准时输入信号的最小电动势，单位μV，或换算成\unit[qualifier-mode=combine]{\deci\bel\of{μ}}V、\unit[qualifier-mode=combine]{\deci\bel\of{m}}V
\item 输出信号达到一定质量标准时输入信号的最小电压，单位μV，或换算成\unit[qualifier-mode=combine]{\deci\bel\of{μ}}V、\unit[qualifier-mode=combine]{\deci\bel\of{m}}V
...
\noindent\textbf{试题：}输出信号达到一定质量标准时，在某输入阻抗为50欧的接收机天线输入端测得输入信号的最小电压为1μV，该接收机灵敏度的功率电平\unit[qualifier-mode=combine]{\deci\bel\of{m}}数值为：
\begin{enumerate}[leftmargin=3em]
\item -107\unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -103\unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -73\unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -113\unit[qualifier-mode=combine]{\deci\bel\of{m}}
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{试题：}输出信号达到一定质量标准时，在某输入阻抗为50欧的接收机天线输入端测得输入信号的最小电压为1μV，该接收机敏度用\unit[qualifier-mode=combine]{\deci\bel\of{μ}}V表示的数值为：
\begin{enumerate}[leftmargin=3em]
\item 6\unit[qualifier-mode=combine]{\deci\bel\of{μ}}V
\item -2\unit[qualifier-mode=combine]{\deci\bel\of{μ}}V
\item 3\unit[qualifier-mode=combine]{\deci\bel\of{μ}}V
\item 0\unit[qualifier-mode=combine]{\deci\bel\of{μ}}V
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{试题：}输出信号达到一定质量标准时，在某输入阻抗为50欧的接收机天线输入端测得输入信号的最小电压为0.5 μV，该接收机敏度的功率电平\unit[qualifier-mode=combine]{\deci\bel\of{m}}数值为：
\begin{enumerate}[leftmargin=3em]
\item -113 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -107\unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -103 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
...
\noindent\textbf{试题：}输出信号达到一定质量标准时，在某输入阻抗为50欧的接收机天线输入端测得输入信号的最小电压为0.5μV，该接收机敏度用\unit[qualifier-mode=combine]{\deci\bel\of{μ}}V表示的数值为：
\begin{enumerate}[leftmargin=3em]
\item 0\unit[qualifier-mode=combine]{\deci\bel\of{μ}}V
\item -2\unit[qualifier-mode=combine]{\deci\bel\of{μ}}V
\item 3\unit[qualifier-mode=combine]{\deci\bel\of{μ}}V
...
\begin{enumerate}[leftmargin=3em]
\item -107\unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item 0.02\unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -103\unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -113\unit[qualifier-mode=combine]{\deci\bel\of{m}}
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\item -113\unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -107\unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item 0.01\unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -103\unit[qualifier-mode=combine]{\deci\bel\of{m}}
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{试题：}接收机的接收信号强度表每两档的信号强度相差6dB。接收某电台信号，发射功率为10\unit[qualifier-mode=combine]{\deci\bel\of{W}}时读数为S8。该台减小发射功率后，接收机读数变为S5。此时该台的发射功率约为（以W为单位）：
\begin{enumerate}[leftmargin=3em]
\item 0.156W
\item 0.098W
\item 10.24W
...
\noindent\textbf{试题：}功率为0 \unit[qualifier-mode=combine]{\deci\bel\of{m}}的射频信号通过增益为 23 dB的电路后，输出功率为：
\begin{enumerate}[leftmargin=3em]
\item 0.2W
\item 23mW
\item 23W
...
\noindent\textbf{试题：}功率为0\unit[qualifier-mode=combine]{\deci\bel\of{μ}}的射频信号通过增益为 36 dB的电路后，输出功率为：
\begin{enumerate}[leftmargin=3em]
\item 4mW
\item 3.6W
\item 36mW
...
\noindent\textbf{试题：}功率为0 \unit[qualifier-mode=combine]{\deci\bel\of{W}}的射频信号通过增益为 -36 dB的电路后，输出功率为：
\begin{enumerate}[leftmargin=3em]
\item 0.25 mW
\item 3.6mW
\item 25mW
...
\noindent\textbf{试题：}功率为0 \unit[qualifier-mode=combine]{\deci\bel\of{W}}的射频信号通过衰减量为 40 dB的衰减器后，输出功率为：
\begin{enumerate}[leftmargin=3em]
\item 100μW
\item 40mW
\item 140μW
...
\noindent\textbf{试题：}业余条件测试天线增益的典型方法如图。用场强表或接收机接收设置在远处同一地点、最大辐射方向朝向自己的半波偶极天线（上）和待测天线（下）。调整送到两副天线的射频功率Po和P，使接收到的场强相同。待测天线的增益\unit[qualifier-mode=combine]{\deci\bel\of{d}}值为：
\begin{enumerate}[leftmargin=3em]
\item 10 lg(Po/P)
\item 10 lg(P/Po)
\item P - Po
...
\noindent\textbf{试题：}业余条件测试天线增益的典型方法如图。用场强表或接收机接收设置在远处同一地点、最大辐射方向朝向自己的半波偶极天线（上）和待测天线（下）。调整送到两副天线的射频功率Po和P，使接收到的场强相同。待测天线的增益\unit[qualifier-mode=combine]{\deci\bel\of{i}}值为：
\begin{enumerate}[leftmargin=3em]
...
\noindent\textbf{试题：}已知某天线的增益为3.85 \unit[qualifier-mode=combine]{\deci\bel\of{d}}，馈入的功率为10W，其等效全向辐射功率（e.i.r.p）为：
\begin{enumerate}[leftmargin=3em]
\item 40W
\item 13.85W
\item 38.5W
...
\noindent\textbf{试题：}已知某天线的增益为5.15 \unit[qualifier-mode=combine]{\deci\bel\of{i}}，馈入的功率为10W，其有效辐射功率（e.r.p）为：
\begin{enumerate}[leftmargin=3em]
\item 20W
\item 51.5W
\item 10W
...
\noindent\textbf{试题：}自由空间中甲乙两台相距100公里，均采用增益为0\unit[qualifier-mode=combine]{\deci\bel\of{i}}的天线，发射端功率1W，工作频率为145\unit{\MHz}，接收端天线得到的信号功率约为-115.6\unit[qualifier-mode=combine]{\deci\bel\of{m}}。如将距离增加为500km，接收到的信号功率将为：【提示：无线电波的自由空间路径损耗为：L=32.4+20logR+20logF，其中R为发射端到接收端的距离（km），F为工作频率（\unit{\MHz}）】
\begin{enumerate}[leftmargin=3em]
\item -129.6 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -101.6 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -135.6 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -95.6 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{试题：}自由空间中甲乙两台相距100公里，均采用增益为0\unit[qualifier-mode=combine]{\deci\bel\of{i}}的天线，发射端功率1W，工作频率为145\unit{\MHz}，接收端天线得到的信号功率约为-115.6\unit[qualifier-mode=combine]{\deci\bel\of{m}}。如将距离增加为1000km，接收到的信号功率将为：【提示：无线电波的自由空间路径损耗为：L=32.4+20logR+20logF，其中R为发射端到接收端的距离（km），F为工作频率（\unit{\MHz}）】
\begin{enumerate}[leftmargin=3em]
\item -135.6 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -95.6 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -129.6 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
...
\noindent\textbf{试题：}自由空间中甲乙两台相距100公里，均采用增益为0\unit[qualifier-mode=combine]{\deci\bel\of{i}}的天线，发射端功率1W，工作频率为145\unit{\MHz}，接收端天线得到的信号功率约为-115.6\unit[qualifier-mode=combine]{\deci\bel\of{m}}。如将频率改为435\unit{\MHz}，接收到的信号功率将约为：【提示：无线电波的自由空间路径损耗为：L=32.4+20logR+20logF，其中R为发射端到接收端的距离（km），F为工作频率（\unit{\MHz}）】
\begin{enumerate}[leftmargin=3em]
\item -125.1 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -109.6 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -129.6 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -135.6 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{试题：}自由空间中甲乙两台相距100公里，均采用增益为0\unit[qualifier-mode=combine]{\deci\bel\of{i}}的天线，发射端功率1W，工作频率为145\unit{\MHz}，接收端天线得到的信号功率约为-115.6\unit[qualifier-mode=combine]{\deci\bel\of{m}}。如将发射功率减少为0.25W，接收到的信号功率将为：【提示：无线电波的自由空间路径损耗为：L=32.4+20logR+20logF，其中R为发射端到接收端的距离（km），F为工作频率（\unit{\MHz}）】
\begin{enumerate}[leftmargin=3em]
\item -121.6 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -109.6 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -129.6 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\item -135.6 \unit[qualifier-mode=combine]{\deci\bel\of{m}}
\end{enumerate}
