...
\end{enumerate}
\textbf{解说：}ITU《无线电规则》（2020年版）第1.137款对\textbf{辐射}的定义：\textbf{任何来源的能量流以无线电波的形式向外发出}。正确的说法是\textbf{闪电产生的电磁波干扰是一种辐射}。\\\noindent\textbf{答案：}D
...
\item 休闲娱乐手段
\end{enumerate}
\noindent\textbf{解说：}ITU《无线电规则》（2020年版）第0.3款：在使用无线电业务的频段时，各主管部门应牢记，无线电频率和任何与之相关的轨道，包括对地静止卫星轨道等相关轨道是有限的\textbf{自然资源}，必须依据《无线电规则》的规定合理而有效率地节省使用，以使各国或国家集团可以在考虑发展中国家和具有特定地理位置的国家的特殊需要的同时，公平地使用这些轨道和频率。
\\\noindent\textbf{答案：}A
%%%
...
\end{enumerate}
\noindent\textbf{解说：}国际业余无线电联盟由\textbf{成员协会、理事会、地区组织}组成。\\\noindent\textbf{答案：}A
%%%
...
\item 调幅波
\end{enumerate}
\noindent\textbf{解说：}ITU《无线电规则》禁止所有电台发射\textbf{减幅波（阻尼波）}。\\\noindent\textbf{答案：}C
