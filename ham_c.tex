...
\usepackage[a4paper,left=3cm,top=2.5cm,bottom=2.5cm,
...
\title{\sffamily {\Huge C类业余无线电台操作技术能力考试\\攻略本}} %书名
...
\noindent\textbf{问题：}必要带宽（necessary bandwidth）是指：对给定的发射类别而言，其恰好足以保证在相应速率及在指定条件下具有所要求质量的信息传输的所需带宽。业余电台单边带话音通信SSB、低速莫尔斯电码通信CW、调频话音通信FM和残余边带业余电视VSB ATV的必要带宽分别是： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 3000Hz、400Hz、12.5kHz、5MH以上
...
\noindent\textbf{问题：}带外发射是指由于调制过程而产生的、刚超出必要带宽的一个或多个频率的发射，但杂散发射除外。如果单边带发射机在发送由两个音频信号组成的双音信号时，产生的三阶互调分量刚超出了必要带宽3kHz。这种分量的发射属于：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 带外发射
\item 杂散发射
\item 谐波发射
...
\noindent\textbf{问题：}[Q]我国在VHF和UHF范围内分配给业余业务和卫星业余业务与其他业务共用并设业务类别为主要业务与次要业务，以下那些频率分配给业余业务和卫星业余业务与其他业务共用并且业余业务和卫星业余业务作为主要业务： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 50MHz、144MHz
\item 144MHz、430MHz
\item 50MHz、430MHz
...
\noindent\textbf{问题：}我国分配给业余业务和卫星业余业务的频率最高的频段及其共用类别是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}我国和ITU分配给业余业务和卫星业余业务的属于低频（LF）和中频（MF）范围的频段分别为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 我国 135.7-137.8kHz；ITU 137.8-138.6kHz和472-479kHz
\item 我国和ITU均为 135.7-137.8kHz
\item 我国和ITU均为472-479kHz
\item 我国 135.7-137.8kHz；ITU为 137.8-139.6kHz
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}商用业余单边带电台的语音信号通道为300-3000Hz，高音频部分衰减很大。如果希望对设备进行改装，以将信号带宽扩展到30-16000Hz，大大提升信号质量。可行的方案是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}发射类别（class of emission）是指用标准符号标示的某发射的一组特性，例如主载波调制方式，调制信号，被发送信息的类型以及其他适用的信号特性。表示用单边带话传输的SSTV信号的发射类别是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item F3F
\item J3E
\item F2B
...
\noindent\textbf{问题：}发射类别（class of emission）是指用标准符号标示的某发射的一组特性，例如主载波调制方式，调制信号，被发送信息的类型以及其他适用的信号特性。表示用调频话传输的RTTY信号的发射类别是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item F2B
\item F3E
\item J3E
...
\noindent\textbf{问题：}发射类别是指用标准符号标示的某发射的一组特性，例如主载波调制方式，调制信号，被发送信息的类型以及其他适用的信号特性。表示用调频话传输的SSTV信号的发射类别是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item F3F
\item F2B
\item J3E
...
\noindent\textbf{问题：}发射类别是指用标准符号标示的某发射的一组特性，例如主载波调制方式，调制信号，被发送信息的类型以及其他适用的信号特性。表示调频ATV信号的发射类别是： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item F3F
\item F2B
\item F3E
...
\noindent\textbf{问题：}国际业余无线电联盟支持会员协会在发展业余无线电时把它看成一种：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 国家资源
\item 拉动经济的措施
\item 休闲娱乐手段
...
\noindent\textbf{问题：}国际业余无线电联盟由下列元素组成：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 成员协会、理事会、地区组织
\item 理事会、地区组织、个人会员
\item 理事会、地区分会、专业委员会
...
\noindent\textbf{问题：}ITU对于5至30MHz短波频率的态度是：（RR 4.11、 4.11）
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}ITU《无线电规则》禁止所有电台发射下列种类的电波：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 减幅波（阻尼波）
\item 调幅波
\item 调频波
...
\noindent\textbf{问题：}C类业余无线电台允许发射的频率为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 各业余业务和卫星业余业务频段
\item 各VHF和UHF频段
\item 限于HF、VHF、UHF范围内的各业余业务和卫星业余业务频段
...
\noindent\textbf{问题：}C类业余无线电台允许发射的最大发射功率为不大于：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 30MHz以下业余频段不大于1000瓦，30MHz以上业余频段不大于25瓦
\item 30MHz以上业余频段不大于1000瓦，30MHz以下业余频段不大于25瓦
\item 25瓦
\item 100瓦
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}负责组织C类业余无线电台所需操作技术能力的验证的机构是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 国家无线电管理机构
\item 地方无线电管理机构
\item 国家无线电管理机构和地方无线电管理机构
...
\noindent\textbf{问题：}业余无线电测向活动所用的隐蔽台属于下列范畴的设备：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}我国规定允许C类业余电台在30MHz以下使用的最大发射功率为1000瓦。正确理解为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}某业余电台CW信号的片段为“by1cra test up 5”，意思是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 该台的呼号为BY1CRA，正在参加竞赛，接收频率从发射频率向上偏移5kHz
\item 该台的呼号为BY1CRA，正在试验信号为UP5的发射设备
\item 该台正在试验设备并且呼叫BY1CRA，请对方在高5kHz的频率回答
...
\noindent\textbf{问题：}业余电台异频收发操作方式（split）的主要适用场合为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在HF频段DX竞赛中回答正在呼叫CQ的参赛电台的方法是，先通过守听搞清其守听频率，然后在其发送“QRZ？”或者在其CQ呼叫停止后进行如下操作：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}下列哪一项，是在竞赛中与其他电台通联时的良好习惯？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}业余收发信机面饭上SPLIT的中文名称和代表的意义是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 异频收发，接收和发射使用互相独立的频率
\item 发射增量调谐，在发射频率的主调谐不变的基础上，对发射频率进行附加微调
\item 接收增量调谐，在接收频率的主调谐不变的基础上，对接收频率进行附加微调
...
\noindent\textbf{问题：}应该关闭接收机AGC功能的情况是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}应选择较短的接收机AGC时间常数的情况是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}应选择较长的接收机AGC时间常数的情况是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 接收SSB和AM等正常信号的包络幅度不断变化的信号
...
\noindent\textbf{问题：}向无线电发射机的话筒输入端施加电压幅度10倍于规定值的音频信号，可能会得到什么效果？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在接收通信电台的信号时，通常用射频增益和音频增益旋钮就可以获得适当的灵敏度和音量。为什么很多业余无线电接收机还要另设一个衰减（ATT）开关？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}通常的成品收发信机上都有AGC功能，下面那种用法是正确的？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}1.9MHz和3.5MHz等短波低频段业余DX通信经常使用到名词“灰线”。这是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}业余无线电爱好者经常用“灰线”预测1.9MHz和3.5MHz等短波低频段的DX通信效果，基本原理是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}DX SUMMIT上出现这样一行：“PY2SS 28005.3 KH6/N6GQ Simplex, fading signal in SA 2040 15 Feb 2012”，以下描述正确的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}DX SUMMIT上出现这样一行：JA2WS 14009.6 E51WWA Calling CQ, no takers, Cook Is0052 14 Feb 2008。其正确的意思是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}当最高可用频率（MUF）为20MHz时哪个波段具有较大的成功通联机会？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 17m
\item 20m
\item 15m
...
\noindent\textbf{问题：}IOTA活动在20米波段SSB模式和CW模式常用的频率是多少？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 14.260 MHz / 14.040 MHz
\item 14.190 MHz / 14. 040 MHz
\item 14.190 MHz / 14.060 MHz
\item 14.260 MHz / 14.060 MHz
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}NCDXF信标台在20米、17米、15米和10米波段的的频率是？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 14.100 / 18.110 / 21.150 / 28.200 MHz
\item 14.100 / 18.110 /21.150 / 28.100 MHz
\item 14.100 / 18.150 /21.150 / 28.200 MHz
\item 14.100 / 18.100 / 21.150 /28.200 MHz
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}在业余无线电中，莫尔斯电码的信号速度经常用WPM作为单位，其计量方法为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}SSTV或ATV接收到的图像有时发生左右倾斜为平行四边形或斜粗条纹的现象，是因为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 双方的扫描行频不一致。
...
\noindent\textbf{问题：}SSTV 或ATV接收到的图像有时发生中间出现水平粗黑条纹、上下半帧图像错位的现象，是因为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 双方的行频、帧频一致，但是帧扫描的初始时刻不同步
\item 双方的扫描行频不一致。
\item 双方设备没有准确调谐在同一频率上
...
\noindent\textbf{问题：}业余无线电模拟慢扫描电视图像的常用行分辨率为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 每帧128或256行
\item 每帧320或640行
\item 每帧640或720行
...
\noindent\textbf{问题：}业余无线电模拟慢扫描电视图像的音频基带调制方式以及图像信息和调制信号的对应关系为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 调频，白电平为高频率（2300Hz），黑电平为低频率（1500Hz），同步电平为最低频率（1200Hz）
\item 调幅，白电平为高电平（87.5%），黑电平为低电平（30%），同步电平为最低电平（25%）
\item 调幅，白电平为低电平（75%），黑电平为高电平（75%），同步电平为最高电平（100%）
...
\noindent\textbf{问题：}某业余电台要通过短波话音信道传输分辨率为1024x768像素甚至更为精细的电路图，适当的通信方式为： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在监听Robot、Scotte、Martin、SC2等方式的业余SSTV通信时，可以听到信号中伴有一种非常规则的每秒钟重复数次的短促的“咯、咯”声，它们是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 行同步信号
\item 一种超低频寄生振荡
\item 标准频率信标
...
\noindent\textbf{问题：}在业余模拟SSTV通信中，Robot、Scottie、AVT、Martin等不同传送方式有什么差别？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}深空（deep space)是指离地球的距离约等于或大于下列值的空间：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 200万千米
\item 20万千米
\item 10万米
...
\noindent\textbf{问题：}业余地球卫星的轨道倾角（inclination）是指包含：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}业余卫星的周期（period）是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}卫星升轨道（ascending pass）的方向是指轨道的下列区段：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 由南向北
\item 由北向南
\item 由东北向西南
...
\noindent\textbf{问题：}卫星降轨道（descending pass）的方向是指轨道的下列区段：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 由北向南
\item 由南向北
\item 由东北向西南
...
\noindent\textbf{问题：}在业余无线电领域中，缩写AMSAT是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在描述业余无线电卫星时经常用到缩写OSCAR（奥斯卡），这个名称的由来是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}业余卫星一般采用低轨道或者椭圆轨道设计，主要原因是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 发射成本低
\item 卫星转发器功率可以增加
\item 增强地球吸引力以保持运转稳定
...
\noindent\textbf{问题：}有时接收到的卫星下行信号强度会出现周期性的快衰落，这是因为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在安装卫星轨道预测软件后，在预测卫星位置之前必须进行的准备工作是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}业余卫星通信中所说的A、B、K、JA、JD、S、T等工作方式，表示的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}申请WAS奖状时，不能用以下哪个呼号的卡片作为通联证明卡片：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item VA3EJ
\item AC6HY
\item N8DX
...
\noindent\textbf{问题：}申请5BWAZ奖状，至少要提交多少个不同分区的卡片：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 198
\item 199
\item 200
...
\noindent\textbf{问题：}在CQWW系列比赛中，哪些组别不能使用CW SKIMMER作为辅助工具使用：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item SOAB
\item SOAB-A
\item SOSB-20
...
\noindent\textbf{问题：}卫星和6米的WAZ奖状需要申请者提交至少多少个区的QSL卡片：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 25
\item 30
\item 35
...
\noindent\textbf{问题：}160m的WAZ奖状需要申请者提交至少多少个区的QSL卡片：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 25
\item 30
\item 35
...
\noindent\textbf{问题：}BG1DOB在IARU HF World Championship竞赛中通联到某个电台，信号报告为599JARL，那么这个电台的呼号有可能是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 8N1HQ
\item BA4RF
\item B4HQ
...
\noindent\textbf{问题：}北京20岁女大学生参加IARU HF World Championship单人组比赛，她发给别人的信号报告有可能是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 5944
\item 5900
\item 5924
...
\noindent\textbf{问题：}北京20岁女大学生参加ALL ASIAN SSB单人组比赛，她发给别人的信号报告有可能是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 5900
\item 5944
\item 5924
...
\noindent\textbf{问题：}北京20岁女大学生参加CQ WW CW竞赛，她发给别人的信号报告有可能是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 59924
\item 59900
\item 59944
...
\noindent\textbf{问题：}以北京为中心与DXCC实体3X、HZ、G、OE之间的大圆距离由远及近的排序为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 3X、G、OE、HZ
\item 3X、HZ、OE、G
\item G、OE、3X、HZ
...
\noindent\textbf{问题：}某业余电台在参加比赛，对方报来的交换信息是599CN，这个业余电台参加的比赛是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}按照竞赛惯例，以下频率中不能用于IOTA竞赛的有？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 3560-3600 kHz
\item 7040-7060 kHz
\item 14060-14125 kHz
\item 14300-14350 kHz
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}关于地面无线电通信（terrestrial radio communication）的正确说法是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 航空通信属于地面无线电通信
\item 水上通信不属于地面无线电通信
...
\noindent\textbf{问题：}无线电技术中常遇到的术语“互感现象”是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}高档无线电通信设备的说明书经常会出现缩写TCXO或OCXO。它们是分别指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}无线电原理经常用到缩写VXO，它代表：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 可变石英振荡器
\item 可变频率振荡器
\item 石英晶体元件
...
\noindent\textbf{问题：}无线电原理经常用到缩写VCO，它代表：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 压控振荡器
\item 可变石英振荡器
\item 可变频率振荡器
...
\noindent\textbf{问题：}最小值为-50伏、峰-峰值为100伏的方波电压，其有效值电压为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 50伏
\item 约70.7伏
\item 约35.4伏
...
\noindent\textbf{问题：}最小值为0、峰-峰值为100伏的方波电压，其有效值电压为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 50伏
\item 约70.7伏
\item 约35.4伏
...
\noindent\textbf{问题：}最小值为-50伏、峰-峰值为100伏的三角波电压，其有效值电压为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 25伏
\item 50伏
\item 约70.7伏
...
\noindent\textbf{问题：}最小值为0、峰-峰值为100伏的三角波电压，其有效值电压为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 50伏
\item 约70.7伏
\item 25伏
...
\noindent\textbf{问题：}最小值为-50伏、峰-峰值为100伏的方波电压，其平均值电压为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 0
\item 50伏
\item 约70.7伏
...
\noindent\textbf{问题：}最小值为0、峰-峰值为100伏的方波电压，其平均值电压为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 50伏
\item 约70.7伏
\item 约35.4伏
...
\noindent\textbf{问题：}最小值为-50伏、峰-峰值为100伏的三角波电压，其平均值电压为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 0
\item 25伏
\item 50伏
...
\noindent\textbf{问题：}最小值为0、峰-峰值为100伏的三角波电压，其平均值电压为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 50伏
\item 约70.7伏
\item 25伏
...
\noindent\textbf{问题：}二极管在无线电技术里广泛用于整流或检波，主要是利用了它的下列性能：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 单向导电
\item 电流放大
\item 高频滤波
...
\noindent\textbf{问题：}三极电子管的三个基本电极是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 阴极（灯丝）、栅极、屏极（板极）
\item 发射极、基极、集电极
\item 源极、栅极、漏极
...
\noindent\textbf{问题：}双极型半导体三极管的三个基本电极是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 发射极、基极、集电极
\item 阴极（灯丝）、栅极、屏极（板极）
\item 源极、栅极、漏极
...
\noindent\textbf{问题：}场效应型半导体三极管的三个基本电极是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 源极、栅极、漏极
\item 阴极（灯丝）、栅极、屏极（板极）
\item 发射极、基极、集电极
...
\noindent\textbf{问题：}现代无线电电路大量应用表面装焊元器件（Surface Mounted Devices）。其规格参数0402、0603、0805、1206等是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 元器件的长和宽（以单位：毫米或0.1英寸）
\item 容量值（单位：微法）
\item 电阻值（单位：千欧）
\item 电感值（单位：微亨）
\end{enumerate}
...
\noindent\textbf{问题：}业余无线电收发信机所用的半导体器件经常会在型号或者使用说明中用一组字母加以描述，例如 SIP、DIP、SOT、SOP、SSOP、QFP等，它们用来说明：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 器件的封装形式
\item 器件的工作温度范围
\item 器件的输入输出电平范围
...
\noindent\textbf{问题：}有些无线电收发信机在外接13.8V直流电源插座后正向串联一个大电流二极管作为保护。所利用的二极管的特性和动作原理为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 二极管的单向导电特性；在接反电源极性时自动阻断电源
\item 大电流二极管的散热性能；帮助电路发散热量，防止设备过热
\item 二极管导电区的非线性；在电源过压时加大压降，起到稳压作用
\item 二极管导电区的非线性；在设备电流超限时加大压降，起到限流作用
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}有些无线电收发信机在外接13.8V直流电源插座后串联一个熔断器，并在电源线的设备端反向跨接一个大电流二极管作为保护。所利用的二极管的特性和动作原理为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 二极管的单向导电特性；接反电源极性时造成很大短路电路，烧断熔丝，造成电源永久切断
\item 大电流二极管的散热性能；帮助电路发散热量，防止设备过热
\item 二极管导电区的非线性；在电源过压时加大压降，起到稳压作用
\item 二极管导电区的非线性；在设备电流超限时加大压降，起到限流作用
\end{enumerate}
...
\noindent\textbf{问题：}用一副臂长约10cm的小偶极天线并联一个半导体二极管和直流微安表，做一个简单的天线场强表。应选用硅二极管还是锗二极管，正确的考虑是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 锗、硅二极管的起始导通电压分别为0.3和0.7V，应选用锗二极管使场强表比较灵敏
\item 所有二极管都具有同样的单向导电特性，采用锗、硅二极管效果完全相同
\item 硅二极管反向击穿电压比较高，应选用硅管使场强表延长使用寿命
\item 电路过于简单，无论使用锗、硅二极管，都无法工作
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}将发光二极管接到直流电源上时的注意点是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 正向连接，需串联限流电阻
\item 反向连接，需串联限流电阻
\item 正向无所谓，但需并联限流电阻
...
\noindent\textbf{问题：}三极电子管至少应有几个引出电极？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 4个
\item 2个
\item 3个
...
\noindent\textbf{问题：}三极电子管的放大作用表现在：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 较小的栅极信号电压变化可以引起较大的屏极电流的成比例变化
\item 较小的阴极电流变化就可以引起较大的屏极电压的成比例变化
\item 较小的栅极信号电流变化可以引起较大的屏极电流的成比例变化
\item 较小的栅极信号电流变化可以引起较大的屏极电压的成比例变化
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}场效应半导体管的放大作用表现在：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 较小的栅极信号电压变化可以引起较大的漏极电流的成比例变化
\item 较小的源极信号电流变化可以引起较大的漏极电压的成比例变化
\item 较小的栅极信号电流变化可以引起较大的漏极电流的成比例变化
\item 较小的栅极信号电流变化可以引起较小的漏极电流的成比例变化
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}双极型半导体管的放大作用表现在：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 较小的基极信号电流变化可以引起较大的集电极电流的成比例变化
\item 较小的发射极信号电流变化可以引起较大的集电极电流的成比例变化
\item 较小的基极信号电压变化可以引起较大的集电极电压的成比例变化
\item 较小的基极信号电压变化可以引起较大的集电极电流的成比例变化
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}描述三极电子管放大能力的最常用参数、单位及符号是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 互导（跨导）； 单位为毫安/伏；符号为“gm”
\item 电流放大倍数；没有单位量纲；符号为“β”
\item 互导（跨导）； 单位为“倍”；符号为“A”
\item 电压放大倍数；没有单位量纲；符号为“k”
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}描述场效应半导体三极管放大能力的最常用参数、单位及符号是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 互导（跨导）；； 单位为毫安/伏；符号为“gm”
\item 电流放大倍数；没有单位量纲；符号为“β”
\item 互导（跨导）； 单位为“倍”；符号为“A”
...
\noindent\textbf{问题：}描述双极型半导体三极管放大能力的最常用参数、单位及符号是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 电流放大倍数；没有单位量纲；符号为“β”
\item 互导（跨导）； 单位为毫安/伏；符号为“gm”
\item 互导（跨导）； 单位为“倍”；符号为“A”
...
\noindent\textbf{问题：}按输入阻抗由低到高排列为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 双极型半导体三极管、结型场效应三极管、金属绝缘栅场效应三极管
\item 双极型半导体三极管、金属绝缘栅场效应三极管、结型场效应三极管
\item 金属绝缘栅场效应三极管、双极型半导体三极管、结型场效应三极管
\item 结型场效应三极管、双极型半导体三极管、金属绝缘栅场效应三极管
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}下列哪一种元器件由三层半导体材料制作而成？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 双极型晶体管
\item 发电机
\item 三极电子管
...
\noindent\textbf{问题：}通常如何从外表识别半导体二极管的负极？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}二极管的两个电极分别叫什么？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 正极和负极
\item 源极和漏极
\item 加极和减极
...
\noindent\textbf{问题：}哪一种半导体器件拥有“发射极”？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 双极型晶体管
\item 场效应管
\item 硅二极管
...
\noindent\textbf{问题：}哪一种半导体器件拥有“栅极”？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 场效应管
\item 双极型晶体管
\item 硅二极管
...
\noindent\textbf{问题：}下列哪一个名字用来描述晶体管放大信号的能力？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 增益
\item 前向电阻
\item 前向压降
...
\noindent\textbf{问题：}电阻的色环从靠近边缘的一个数起，分别为棕、橙、橙、黑，其阻值为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 13千欧
\item 3700欧
\item 4.7兆欧
...
\noindent\textbf{问题：}电阻的色环从靠近边缘的一个数起，分别为黄、白、红、银，其阻值为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 4900欧
\item 49千欧
\item 4.7兆欧
...
\noindent\textbf{问题：}电阻的色环从靠近边缘的一个数起，分别为棕、橙、橙、黑、银，其阻值为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 133欧
\item 13千欧
\item 4.7兆欧
...
\noindent\textbf{问题：}电阻的色环分别依次为金、红、黑、灰、橙，其阻值为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 38000欧
\item 208千欧
\item 28千欧
...
\noindent\textbf{问题：}电阻的色环分别依次为金、棕、黑、白、黄，其阻值为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 4900欧
\item 1090千欧
\item 109千欧
...
\noindent\textbf{问题：}把一个电感值为100微亨的线圈跨接在电路上，不致严重妨碍原电路工作或造成安全危险的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}把一个电容量为1000微法的电容器跨接在电路上，不致严重妨碍原电路工作或造成安全危险的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 跨接在12伏蓄电池两端
\item 跨接在HF收发信机天线插座两端
\item 跨接在输出阻抗为600欧的音响信号线两端
...
\noindent\textbf{问题：}电路图中，电解电容器所标注的电容量值的缺省单位是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 法拉
\item 毫法拉
\item 皮法拉
...
\noindent\textbf{问题：}电路图中，非电解电容器所标注的大于1的整数或小数电容量值的缺省单位是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 皮法拉
\item 微法拉
\item 法拉
...
\noindent\textbf{问题：}在电路图中或元件上，非电解电容器的容量标注为3位数字时，读取容量的方法为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在电路图中或原件上，电阻的阻值标注为3位数字时，读阻值的方法为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在电路图中或元件上，电阻的阻值标注为2或3位数字和一个字母（例如8R2、27K、1M5）时，读阻值的方法为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}电路图中，非电解电容器所标注的小于1的小数电容量值的缺省单位是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 微法拉
\item 皮法拉
\item 法拉
...
\noindent\textbf{问题：}无线电设备中的变压器铁芯一般都用矽钢片堆迭或采用不导电的磁性材料，而不像继电器那样采用整块铁芯。这是因为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在电感线圈中加入适当磁性材料做成的磁芯可以减少电流通过时的损耗，是因为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在很多无线电和电子电路的旁路电容滤波电路中，经常将一大容量电容器与一小容量电容器 并联，这样的作用是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}一个电容器，在某一频率下测得容抗为若干欧姆。如果频率提高N倍，其容抗将：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 减少到原来的1/N
\item 增大到原来的N倍
\item 减少到原来的1/（2πN）
...
\noindent\textbf{问题：}一个电感线圈，在某一频率下测得感抗为若干欧姆。如果频率提高N倍，其感抗将：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 增大到原来的N倍
\item 减少到原来的1/N
\item 增大到原来的2πN倍
...
\noindent\textbf{问题：}一个电容器，在50Hz频率下实测得容抗为100欧姆。按容抗公式计算，在5MHz时容抗应为0.001欧姆，但实测到的阻抗明显偏大。这是因为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 电容器引线在频率变高后带来不可忽略的感抗
\item 仪器的频率特性欠佳
\item 容抗计算公式在高频率下不适用
\item 电容器介质损耗造成非线性失真
\end{enumerate}
...
\noindent\textbf{问题：}一个电感线圈，在50Hz频率下实测得感抗为10欧姆。按感抗公式计算，在5MHz时感抗应为1兆欧，但实测到的阻抗明显偏小。这是因为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 电感线圈的分布电容在频率变高后带来不可忽略的容抗
\item 仪器的频率特性欠佳
\item 感抗计算公式在高频率下不适用
\item 电感线圈导线损耗造成非线性失真
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}在电容器两端施加一个正弦交流电压，则流过电容器的电流是正弦交流电流，该电流相位：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 超前于电压相位90度
\item 落后于电压相位90度
\item 与电压相位相同
...
\noindent\textbf{问题：}使一个正弦交流电流流过电容器，则电容器两端的电压是正弦交流电压，该电压相位：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 落后于电流相位90度
\item 超前于电流相位90度
\item 与电压相位相同
...
\noindent\textbf{问题：}在线圈两端施加一个正弦交流电压，则流过线圈的电流是正弦交流电流，该电流相位：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 落后于电压相位90度
\item 超前于电压相位90度
\item 与电压相位相同
...
\noindent\textbf{问题：}使一个正弦交流电流流过线圈，则线圈两端的电压是正弦交流电压，该电压相位：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 超前于电流相位90度
\item 落后于电流相位90度
\item 与电流相位相同
...
\noindent\textbf{问题：}在电容、电感串联电路中，如果电容的容抗与电感的感抗大小相等，描述这一状态最适当的术语是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 谐振
\item 匹配
\item 叠加
...
\noindent\textbf{问题：}由电感为L的线圈、容量为C的电容组成LC谐振电路，其谐振频率f为：（L、C和f的单位分别为微亨、微法拉和兆赫, “x＾m”表示“x的m次方”）
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item f = 1/（2π(LC)＾(1/2)）
\item f = 2π(LC)＾(1/2)
\item f = 1/((2πLC)＾2)
...
\noindent\textbf{问题：}能够以电场形式储存能量的元件是什么？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 电容
\item 电阻
\item 压敏元件
...
\noindent\textbf{问题：}能够以磁场形式储存能量的元件是什么？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 电感
\item 电阻
\item 电磁铁
...
\noindent\textbf{问题：}图示电路为业余无线电爱好者常用的简易场强表。各部件的作用分别为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}将电阻R和电容C串联后突然接到直流电压U上，电容C两端的电压在经过时间常数T后大约会达到U的：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 63%
\item 99%
\item 37%
...
\noindent\textbf{问题：}将电阻R和电容C串联后突然接到直流电压U上，电阻R两端的电压在经过时间常数T后大约会达到U的：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 37%
\item 99%
\item 63%
...
\noindent\textbf{问题：}将电阻R和电感L串联后突然接到直流电压U上，电感L两端的电压在经过时间常数T后大约会达到U的：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 37%
\item 99%
\item 63%
...
\noindent\textbf{问题：}将电阻R和电感L串联后突然接到直流电压U上，电阻R两端的电压在经过时间常数T后大约会达到U的：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 63%
\item 99%
\item 37%
...
\noindent\textbf{问题：}将继电器的线圈接在开关三极管的集电极电路中，用三极管控制继电器的通断。可能发生的现象是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}用开关器件控制继电器线圈的通断时，经常要在继电器线圈两端并联一个二极管或者电容，其作用是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}用继电器控制直流负载时，有时在继电器接点线圈两端并联一个电容，其作用是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 消除继电器接点通断时产生的火花干扰
\item 吸收继电器线圈电感在电路关断瞬间感应出的反向电动势以保护开关器件
\item 减少通过开关器件的工作电流
...
\noindent\textbf{问题：}“Q值”是经常被用来描述谐振回路或者谐振天线电路的一个电气参数。它表示的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}根据谐振回路或者谐振天线电路Q值的高低可以做出如下判断：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}滤波器有一个称为“通带波动”的参数，是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在下列种类的谐振回路中，通频带最窄的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}无线电设备的放大器中大量使用了负反馈技术。与没有反馈的相比，负反馈放大器的特点是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}采用锁相环频率合成器的收发信机会在信号中带有附加的相位噪声，主要原因是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}电路分析经常用到理想运算放大器的概念。理想运算放大器是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 开环放大倍数无穷大的放大器
\item 内部噪声等于零的放大器
\item 输出电压幅度没有限制的放大器
...
\noindent\textbf{问题：}半导体三极管放大器的输入阻抗由低到高的排列为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}半导体三极管放大器的电流放大倍数由低到高的排列为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 共基极放大器、共发射极放大器、共集电极放大器
\item 共集电极放大器、共发射极放大器、共基极放大器
\item 共发射极放大器、共集电极放大器、共基极放大器
...
\noindent\textbf{问题：}工作在HF频段的电子管射频线性功率放大器多采用共栅极放大电路，这是因为共栅极放大电路： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在下面的三极管放大电路中，Rc的常用名称和作用是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在下面的三极管放大电路中，Re的常用名称和作用是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 发射极负反馈电阻，稳定直流工作点
\item 负载电阻，将集电极信号电流转换为信号电压
...
\noindent\textbf{问题：}在下面的三极管放大电路中，Rb1的常用名称和作用是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 偏流电阻，为晶体管提供偏置电流以工作在适当工作点
...
\noindent\textbf{问题：}在下面的三极管放大电路中，Cb的常用名称和作用是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在下面的三极管放大电路中，Ce的常用名称和作用是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 旁路电容，使发射极交流信号电流分量顺利通过，不致在Re造成压降形成负反馈
\item 输入耦合（或隔直流）电容，使输入交流信号电流进入放大器但阻隔直流电流分量出入
\item 输出耦合（或隔直流）电容，使输出交流信号顺利输出但阻隔直流分量电流出入
...
\noindent\textbf{问题：}在下面的三极管放大电路中，Cc的常用名称和作用是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 输出耦合（或隔直流）电容，使输出交流信号顺利输出但阻隔直流分量电流出入
\item 输入耦合（或隔直流）电容，使输入交流信号电流进入放大器但阻隔直流电流分量出入
\item 旁路电容，使发射极交流信号电流分量顺利通过，不致在Re造成压降形成负反馈
...
\noindent\textbf{问题：}A、B、C、D四类放大器中，可以单独用作射频线性功率放大器、但不能单独用作音频线性功率放大器的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item B
\item A
\item D
...
\noindent\textbf{问题：}A、B、C、D四类放大器中，既可以单独用作射频线性功率放大器、又能单独用作音频线性功率放大器的是： （不考虑电源效率）
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item A
\item B
\item C
...
\noindent\textbf{问题：}A、B、C、D四类放大器中，可以用作FM射频功率放大器的全部类别有： （不考虑电源效率）
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item A、B、C、D
\item A、B、C
\item A、B、D
...
\noindent\textbf{问题：}A、B、C、D四类放大器中，可以用作CW射频功率放大器的全部类别有： （不考虑电源效率）
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item A、B、C、D
\item A、B、C
\item A、B、D
...
\noindent\textbf{问题：}在半导体三极管的基本放大电路中，电压增益最大的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 共发射极放大电路
\item 共基极放大电路
\item 共集电极放大电路
...
\noindent\textbf{问题：}在半导体三极管的基本放大电路中，输入阻抗最高的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 共集电极放大电路
\item 共发射极放大电路
\item 共基极放大电路
...
\noindent\textbf{问题：}在半导体三极管的基本放大电路中，输出阻抗最低的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 共集电极放大电路
\item 共发射极放大电路
\item 共基极放大电路
...
\noindent\textbf{问题：}下列放大器电路中，电源效率最低的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 甲类放大器
\item 乙类放大器
\item 丙类放大器
...
\noindent\textbf{问题：}下列放大器电路中，电源效率最高的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 丙类放大器
\item 甲类放大器
\item 乙类放大器
...
\noindent\textbf{问题：}下列放大器电路中，波形失真最小的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 甲类放大器
\item 乙类放大器
\item 丙类放大器
...
\noindent\textbf{问题：}下列放大器电路中，波形失真最大的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 丙类放大器
\item 甲类放大器
\item 乙类放大器
...
\noindent\textbf{问题：}下列放大器电路中，最适宜用作音频大功率放大器的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 甲乙类放大器
\item 丙类放大器
\item 甲类放大器
...
\noindent\textbf{问题：}下列放大器电路中，最适宜用作音频小信号放大器的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 甲类放大器
\item 甲乙类放大器
\item 丙类放大器
...
\noindent\textbf{问题：}下列放大器电路中，最适宜用作CW射频功率放大器的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 丙类放大器
\item 甲类放大器
\item 甲乙类放大器
...
\noindent\textbf{问题：}下列放大器电路中，最适宜用作FM射频功率放大器的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 丙类放大器
\item 甲类放大器
\item 甲乙类放大器
...
\noindent\textbf{问题：}下列放大器电路中，最适宜用作SSB射频功率放大器的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 接近乙类的甲乙类放大器
\item 接近甲类的甲乙类放大器
\item 丙类放大器
...
\noindent\textbf{问题：}业余电台发射单边带语音信号时，附近连接在某电路上的耳机传出了模糊不清的语音。可以断定这个电路具有下列功能：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 检波
\item 差拍
\item 变频
...
\noindent\textbf{问题：}业余电台发射等幅波电码信号时，附近连接在某电路上的耳机传出了“嘟嘟”的音频电码声。可以断定这个电路具有下列功能：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 差拍
\item 检波
\item 变频
...
\noindent\textbf{问题：}试验某电路，接通电源时，旁边的无线电收信机可以收到它发出的类似鸟叫的声音，断开电源，鸟叫声消失。可以断定这个电路具有下列功能：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 振荡
\item 差拍
\item 检波
...
\noindent\textbf{问题：}用收信机的AM挡接收中等强度的SSB语音信号，调谐到最佳状态，听到的将是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 模糊不清的类似语音的声音
\item 正常的语音
\item 听不到任何语音
...
\noindent\textbf{问题：}用收信机的AM挡接收中等强度的FM语音信号，调谐到最佳状态，听到的将是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 听不到语音，信号越强越寂静
\item 正常的语音
\item 差拍叫声
...
\noindent\textbf{问题：}用收信机的SSB挡接收中等强度的FM语音信号，调谐到最佳状态，听到的将是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 差拍叫声
\item 模糊不清的类似语音的声音
\item 正常的语音
...
\noindent\textbf{问题：}用收信机的SSB挡接收中等强度的AM语音信号，调谐到最佳状态，听到的将是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 正常的语音
\item 差拍叫声
\item 模糊不清的类似语音的声音
...
\noindent\textbf{问题：}用收信机的FM挡接收中等强度的AM语音信号，调谐到最佳状态，听到的将是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}用收信机的FM挡接收中等强度的SSB语音信号，调谐到最佳状态，听到的将是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}一个语音信号，经过USB发射机调制成为一个射频信号。从频率域的观点看，上边带调制的过程是发生了：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 频谱的简单平移
...
\noindent\textbf{问题：}利用个人电脑和用于传送语音的普通收发信机进行业余短波SSTV通信所用到的调制方式为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}利用个人电脑和用于传送语音的普通收发信机进行业余短波RTTY通信所用到的调制方式有：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}利用个人电脑和用于传送语音的普通收发信机进行业余短波PSK31通信所用到的调制方式有：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item PSK（数字信息的音频基带信号调制）和SSB（频率搬移）
\item FSK（数字信息的音频基带信号调制）和SSB（频率搬移）
...
\noindent\textbf{问题：}利用PC电脑和用于传送语音的普通收发信机进行业余短波PACKET通信所用到的调制方式有：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item FSK（数字信息的音频基带信号调制）和SSB（频率搬移）
\item AM（数字信息的音频基带信号调制）和SSB（频率搬移）
\item PSK（数字信息的音频基带信号调制）和SSB（频率搬移）
...
\noindent\textbf{问题：}模拟ATV和模拟广播电视通信中，图像信号调制方式的差别是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}下列哪一项可以解调FM信号？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 鉴频器
\item 限幅器
\item 乘积检波器
...
\noindent\textbf{问题：}下列哪一种可以归入调幅通信？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 单边带通信
\item 封包通信
\item 扩频通信
...
\noindent\textbf{问题：}在VHF封包通信中，哪一种调制模式被广泛使用？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item FM
\item SSB
\item AM
...
\noindent\textbf{问题：}现代无线电通信技术大量使用数字处理技术，处理模拟信号时首先要进行模数转换。模数转换器所要求的转换速率取决于：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 待处理信号的最高频率分量
\item 待处理信号的最低频率分量
...
\noindent\textbf{问题：}现代无线电通信技术大量使用数字处理技术，处理模拟信号时首先要进行模数转换。模数转换器所要求的采样精度位数取决于：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 待处理信号波形的复杂程度
\item 待处理信号的最高频率分量
\item 待处理信号的最低频率分量
...
\noindent\textbf{问题：}在模数转换时，要使数字信号能够正确还原出原来的模拟信号，模数转换器的采样速率必须是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 大于信号最高频率分量的2倍
\item 等于信号最高频率分量
...
\noindent\textbf{问题：}将一个频率为f、电压最大值为U的模拟信号进行转换为数字信号。如要使数字信号能够反映出信号的相当于0.1%U的幅度细节和相当于f的8次谐波的时间细节，则模数转换器应达到如下指标：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}很多现代收发信机都采用DSP技术对信号进行滤波、调制或解调等处理。其基本处理步骤是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}数字通信中常用到描述信号流量的“信号速率”和描述信息流量的“数据速率”两个参数。业余RTTY通信方式分别用f0和f1两个不同频率信号来传输数字0和1，最常见的每个码元的时间长度为0.02秒。其信号速率和数据速率分别为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 50波特，50位/秒
\item 100波特，100位/秒
\item 50波特，100位/秒
...
\noindent\textbf{问题：}数字通信中常用到描述信号流量的“信号速率”和描述信息流量的“数据速率”两个参数。业余BPSK通信方式中，用一个副载频f的两个相反的相位分别传输数字0和1，每个码元的时间长度约为32毫秒。其信号速率和数据速率分别为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}数字通信中常用到描述信号流量的“信号速率”和描述信息流量的“数据速率”两个参数。MFK16通信方式中，用总带宽316Hz范围内的16个副载频之一来传输16种状态，信号重复频率为64毫秒。其信号速率和数据速率分别为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}数字通信中常用到描述信号流量的“信号速率”和描述信息流量的“数据速率”两个参数。QPSK通信方式中，用一个副载频f的四个相差90度的相位分别传输数字00、01、10和11，每个码元的时间长度约为32毫秒。其信号速率和数据速率分别为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在数字通信中，同时传送多位二进制信息的方式属于并行通信。下列业余无线电数字通信方式中，属于并行通信的有：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item MFSK16
\item BPSK
\item RTTY
...
\noindent\textbf{问题：}假设以同样的信息传输速率传输报文，MFSK16通信方式的波特率低于信息传输速率，RTTY通信方式的波特率等于信息传输速率。根据这一描述，两者相比可以做以下推论：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}我国GB2312-80《信息交换用汉字编码字符集-基本集》标准共收录6763个汉字。不考虑误码的情况，如果要以单个汉字为单位，传输由该字符集的汉字汉字组成的总长度为100字的报文，用RTTY和PSK31通信方式至少分别需要发送多少个字符？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 300,200
\item 100,100
\item 200,200
...
\noindent\textbf{问题：}有些常用的业余无线电数字通信协议只支持5位或者7位数据字节的传送，因而不适合用来传送8位字节的2进制数据文件。常用方式中能够支持2进制数据文件传输的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item PACTOR
\item RTTY
\item AMTOR
...
\noindent\textbf{问题：}业余无线电数据传输控制差错的技术有“前向纠错”和“自动重传请求”两种。前向纠错（Forward Error Correction，FEC）是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}业余无线电数据传输控制差错的技术有“前向纠错”和“自动重传请求”两种。自动重传请求（Automatic Repeat Request，ARQ）是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 发送端在发送一定数据后，如收到接收端的重传请求、或者收不到接收端的收妥确认，即重传出错的数据报文，对出错报文进行纠正
\item 发送端在发送数据报文前先按一定的算法进行编码处理，加入特定的冗余代码，在接收端按照相应算法进行解码，从而发现传输产生的错误并加以纠正
\item 接收端收到数据后，发回发送端，由发送端比较核对，如发现出错，将重传出错的数据报文，从而恢复出错的报文
...
\noindent\textbf{问题：}以CW方式进行速度为25WPM的摩尔斯电码通信，如果考虑传播衰落的影响，必要带宽约为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 200Hz 
\item 2700Hz
\item 6.25kHz
...
\noindent\textbf{问题：}用单边带方式进行RTTY通信，速度为50波特，频偏为170Hz，必要带宽约为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 450Hz 
\item 200Hz
\item 2700Hz
...
\noindent\textbf{问题：}用单边带方式进行话音通信，速度为50波特，频偏为70Hz，必要带宽约为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 2700Hz
\item 200Hz
\item 6.25kHz
...
\noindent\textbf{问题：}国际业余无线电联盟（IARU）业余无线电测向锦标赛规则要求144MHz测向发射机采用调幅度为70%-80%的A2A调制方式发射8-15WPM的音频摩尔斯电码发射电台标识。该类发射占用带宽不得大于下列数值：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 6kHz
\item 12.5kHz
\item 25kHz
...
\noindent\textbf{问题：}无线电通信一般不用调频话方式传输摩尔斯电码，这是因为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}一个PSK31信号在频谱仪上显示为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 一条固定的垂直线
...
\noindent\textbf{问题：}下列几种图表中，最容易用来表达和解释PSK调制原理的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 相位矢量图
\item 波形图
\item 频谱图
...
\noindent\textbf{问题：}下列几种图表中，最容易用来表达和解释SSB调制原理的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 频谱图
\item 波形图
\item 相位矢量图
...
\noindent\textbf{问题：}下列几种图表中，最容易用来表达和解释RTTY调制原理的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 频率-时间曲线
\item 功率-时间曲线
\item 波形图
...
\noindent\textbf{问题：}下列几种图表中，最容易用来表达和解释SSTV调制原理的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 频率-时间曲线
\item 功率-时间曲线
\item 波形图
...
\noindent\textbf{问题：}下列几种图表中，最容易用来表达和解释A、B、C类放大器工作点的差别的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 波形图
\item 频谱图
\item 相位矢量图
...
\noindent\textbf{问题：}将接收机的输出与实时频谱仪或运行频谱显示软件的电脑相连，观察HF频段的RTTY或PACKET模式的DX信号，通常看到两个幅度相同的谱峰。但有时两个谱峰的高度会变得不等并且不断变化。造成这种现象的原因是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 电离层的选择性衰落
\item 仪器或电脑工作点飘移
\item 发射机的发射功率电平不稳定
...
\noindent\textbf{问题：}比较考究的接收机说明书中常列出一项“通带矩形系数”或“通带形状系数”的指标，是用来描述：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}根据说明书列出的技术指标，两台业余无线电接收机在USB方式下选择带宽为2.7kHz的滤波器时具有不同的“通带矩形系数”。接收机A的“60dB带宽对6dB带宽的矩形系数”为3.8，接收机B的 为5。由此可作出推论：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}根据说明书列出的技术指标，两台业余无线电接收机的“通带波动”分别为1dB和3dB。由此可作出推论：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}用功率电平表示的接收机灵敏度的意义以及常用单位是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 输出信号达到一定质量标准时输入信号的最小功率电平，单位dBm或dBμW
...
\noindent\textbf{问题：}用电压电平表示的接收机灵敏度在无线电理论中的意义以及常用单位是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 输出信号达到一定质量标准时输入信号的最小电动势，单位μV，或换算成dBμV、dBmV
\item 输出信号达到一定质量标准时输入信号的最小电压，单位μV，或换算成dBμV、dBmV
...
\noindent\textbf{问题：}输出信号达到一定质量标准时，在某输入阻抗为50欧的接收机天线输入端测得输入信号的最小电压为1μV，该接收机敏度用电压μV表示的数值为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 2μV
\item 1μV
\item 50μV
...
\noindent\textbf{问题：}输出信号达到一定质量标准时，在某输入阻抗为50欧的接收机天线输入端测得输入信号的最小电压为1μV，该接收机灵敏度的功率电平dBm数值为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item -107dBm
\item -103dBm
\item -73dBm
...
\noindent\textbf{问题：}输出信号达到一定质量标准时，在某输入阻抗为50欧的接收机天线输入端测得输入信号的最小电压为1μV，该接收机敏度用dBμV表示的数值为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 6dBμV
\item -2dBμV
\item 3dBμV
...
\noindent\textbf{问题：}输出信号达到一定质量标准时，在某输入阻抗为50欧的接收机天线输入端测得输入信号的最小电压为0.5μV，该接收机敏度用电压μV表示的数值为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 1μV
\item 0.5μV
\item 50μV
...
\noindent\textbf{问题：}输出信号达到一定质量标准时，在某输入阻抗为50欧的接收机天线输入端测得输入信号的最小电压为0.5 μV，该接收机敏度的功率电平dBm数值为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item -113 dBm
\item -107dBm
\item -103 dBm
...
\noindent\textbf{问题：}输出信号达到一定质量标准时，在某输入阻抗为50欧的接收机天线输入端测得输入信号的最小电压为0.5μV，该接收机敏度用dBμV表示的数值为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 0dBμV
\item -2dBμV
\item 3dBμV
...
\noindent\textbf{问题：}已知接收机天线输入阻抗为50Ω，电压灵敏度为2μV，其功率灵敏度为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item -107dBm
\item 0.02dBm
\item -103dBm
...
\noindent\textbf{问题：}已知接收机天线输入阻抗为50Ω，电压灵敏度为1μV，其功率灵敏度为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item -113dBm
\item -107dBm
\item 0.01dBm
...
\noindent\textbf{问题：}决定接收机抗拒工作频率附近QRM的主要选择性指标是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}决定接收机接收SSB信号时语音频响均匀度的主要选择性指标是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 带内波动和信道带宽
\item 信道带宽、信道选择性和信道滤波器特性矩形系数
\item 镜像抑制比
...
\noindent\textbf{问题：}“信噪比（SNR）”是无线电技术大量使用的名词，它是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 有用信号功率对噪声功率的比值
...
\noindent\textbf{问题：}对于需要接收微弱信号的业余通信，接收机的噪声系数Fn （以比值的数值形式表达）是一项重要技术指标。它是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}对于需要接收微弱信号的业余通信，接收机的噪声系数Fn （以比值的数值形式表达）是一项重要技术指标。关于Fn的一些基本常识是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}对于需要接收微弱信号的业余通信，接收机的噪声指数NF（以对数形式表达）是一项重要技术指标。它是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}对于需要接收微弱信号的业余通信，接收机的噪声指数NF（以对数形式表达）是一项重要技术指标。关于NF的一些基本常识是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}无线电通信领域中，在描述信号源、放大器、接收机等系统部件的内部噪声大小时，经常用“噪声温度”来度量。以接收机为例，等效噪声温度Te的意义是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}不产生任何内部噪声的理想放大器或接收机的噪声系数Fn、噪声指数NF和噪声温度Te分别为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 1，0dB，0°K
\item 0，0dB，-273°K
\item 0，1dB，17°K
...
\noindent\textbf{问题：}如果一个接收业余卫星用的天线放大器工作在标准温度（17℃）下，其输入端接一副良好匹配的天线。如果放大器所产生的内部噪声与输入的热噪声等效，该放大器的噪声系数Fn、噪声指数NF和噪声温度Te分别为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 2，3dB，290°K
\item 1，1dB，0°K
\item 2，0dB，17°K
...
\noindent\textbf{问题：}单工操作（simplex operation）是指：在一条电信通路的两个方向上交替进行传输的一种工作方式。下列通信采用单工操作方式：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}双工操作（duplex operation）是指：一条电信通路的两个方向能同时进行传输的工作方式。下列通信采用双工操作方式：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 由一台连续工作的430MHz接收机和一台144MHz发信机组成的地面业余电台与业余卫星之间的通信
...
\noindent\textbf{问题：}半双工操作（semi-duplex operation）是指：电路的一端用单工操作，另一端用双工操作的一种工作方式。下列通信采用半双工操作方式：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 一台业余中继台与一台由PTT键转换收发状态的业余对讲机之间的通信
\item 两台具有QSK功能的业余CW收发信之间的通信
\item 两台由PTT键转换收发状态的业余对讲机之间的通信
...
\noindent\textbf{问题：}业余无线电技术描述收信机预选滤波电路和发信机输出滤波电路时，经常会提到LC滤波器的“阶数”或“极点数”。确定LC滤波器阶数的简单办法是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}接收月面反射通信等VHF/UHF微弱信号时常需要在八木天线端加接加接低噪声前置放大器，而HF频段通信很少在八木天线端加装前置放大器。这是因为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}接收机前置放大器的主要作用是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 提高信噪比
...
\noindent\textbf{问题：}在EME通信等需要接收极微弱信号的场合，安装前置放大器时应做到：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}天线的接收单元直接连到适当的放大器就构成有源天线。对于同样结构的天线，使用有源接收天线的目的是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}射频前置放大器通常安装在什么地方？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 在天线和接收机之间
\item 在发射机功放的后面
\item 在发射机和天调之间
...
\noindent\textbf{问题：}学习现代无线电技术或从事业余无线电制作时，经常遇到一种与超外差式收信机具有不同原理的“DC式收信机”。其中缩写DC是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在超外差式变频装置中，所谓“上变频”和“下变频”分别是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}超外差式接收机中混频器的作用是？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 将接收到的信号转换到中频
\item 将几个电台的信号混合在一起
\item 阻止通带以外不必要的信号
...
\noindent\textbf{问题：}一部业余无线电台，SSB发射方式的射频输出峰包功率为10瓦，电源效率约80%。连续发话10秒钟，在此期间发射到空间的平均功率：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 显著低于10瓦
\item 约为12.5瓦
\item 约为10瓦
...
\noindent\textbf{问题：}一部业余无线电台，SSB发射方式的射频输出峰包功率为10瓦，电源效率约80%。在此方式下连续发送RTTY信号10秒钟，在此期间发射到空间的平均功率：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 约为10瓦
\item 显著低于10瓦
\item 约为12.5瓦
...
\noindent\textbf{问题：}一部业余无线电台，SSB发射方式的射频输出峰包功率为10瓦，电源效率约80%。在此方式下连续发送PSK31信号10秒钟，在此期间发射到空间的平均功率：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 约为10瓦
\item 显著低于10瓦
\item 约为12.5瓦
...
\noindent\textbf{问题：}一部业余无线电台，SSB发射方式的射频输出峰包功率为10瓦，电源效率约80%。在此方式下连续发送SSTV信号10秒钟，在此期间发射到空间的平均功率：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 约为10瓦
\item 显著低于10瓦
\item 约为12.5瓦
...
\noindent\textbf{问题：}一副两臂电气长度各为1/4波长的偶极天线，断开中点，通过平衡-不平衡变换器进行馈电，测得谐振频率为f，输入阻抗为Z。如果总长度不变，但将断开的馈电点向一侧偏移1/8波长，最明显的影响将是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}甲、乙业余电台相距10公里，均使用1/2波长水平偶极天线，正在UHF频段进行稳定的通信。现其中一方改用1/2波长垂直偶极天线，改变前后的通信效果的比较将是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 通信效果变差
\item 通信效果没有改变
\item 通信效果变好
...
\noindent\textbf{问题：}甲、乙业余电台相距10公里，分别使用1/2波长水平和垂直偶极天线，正在UHF频段进行稳定的通信。现改为双方都用1/2波长垂直偶极天线，改变前后的通信效果的比较将是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 通信效果变好
\item 通信效果没有改变
\item 通信效果变差
...
\noindent\textbf{问题：}甲、乙业余电台相距10公里，分别使用1/2波长水平和垂直偶极天线，正在UHF频段进行稳定的通信。现改为双方都用1/2波长水平偶极天线，改变前后的通信效果的比较将是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 通信效果变好
\item 通信效果没有改变
\item 通信效果变差
...
\noindent\textbf{问题：}甲、乙业余电台相距10公里，分别使用左旋圆极化和右旋圆极化天线，互相对指，正在UHF频段进行通信。现改为双方都用左旋圆极化天线，比较改变前后的通信效果是： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 通信效果变好
\item 通信效果没有改变
\item 通信效果变差
...
\noindent\textbf{问题：}甲、乙业余电台相距10公里，分别使用左旋圆极化和右旋圆极化天线，互相对指，正在UHF频段进行通信。现改为双方都用右旋圆极化天线，改变前后的通信效果的比较将是： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 通信效果变好
\item 通信效果没有改变
\item 通信效果变差
...
\noindent\textbf{问题：}甲、乙业余电台相距10公里，分别使用左旋圆极化和半波长水平极化天线，互相对指，正在UHF频段进行通信。现乙台改用半波长垂直极化天线，改变前后的通信效果的比较将是： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 通信效果没有改变
\item 通信效果变差
\item 通信效果变好
...
\noindent\textbf{问题：}甲、乙业余电台相距10公里，分别使用左旋圆极化和半波长水平极化天线，正在UHF频段进行通信。现将甲台天线改为右旋圆极化天线，改变前后的通信效果的比较将是： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 通信效果没有改变
\item 通信效果变差
\item 通信效果变好
...
\noindent\textbf{问题：}甲、乙业余电台相距10公里，甲台使用朝向乙台的左旋圆极化天线，乙台使用半波长水平极化天线，正在UHF频段进行通信。现将乙台天线改为朝向甲台的右旋圆极化天线，改变前后的通信效果的比较将是： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 通信效果变差
\item 通信效果变好
\item 通信效果没有改变
...
\noindent\textbf{问题：}甲、乙业余电台相距10公里，甲台使用朝向乙台的左旋圆极化天线，乙台使用半波长水平极化天线，正在UHF频段进行通信。现将乙台天线改为朝向甲台的左旋圆极化天线，改变前后的通信效果的比较将是： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 通信效果变好
\item 通信效果变差
\item 通信效果没有改变
...
\noindent\textbf{问题：}甲、乙业余电台相距10公里，分别使用左旋圆极化和右旋圆极化天线，互相对指，正在UHF频段进行通信。现将双方天线均改为半波长水平极化天线，改变前后的通信效果的比较将是： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 通信效果变好
\item 通信效果没有改变
\item 通信效果变差
...
\noindent\textbf{问题：}假设收发天线均采用半波长偶极天线。在地面电台之间的近距离通信中，发射天线和接收天线的最佳极化方式为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}右旋（或顺时针）极化波[right-hand（clockwise）polarized wave]是指：在任何一个垂直于传播方向的固定平面上，顺着传播方向看去，其电场向量随时间向右（顺时针方向）旋转的椭圆极化波或圆极化波。从地面某业余电台看一颗业余卫星，发现从卫星到达该台的无线电波的电场是按顺时针方向旋转的，其极化方式为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在视距通信中，已知发射天线为指向接收点的左旋圆极化天线，接收天线的最佳极化方式为： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 指向发射点的左旋圆极化
\item 指向发射点的右旋圆极化
\item 垂直极化
...
\noindent\textbf{问题：}卫星采用右旋圆极化天线，从北向南飞行，天线一直指向地球的南极。地面业余电台采用自动跟踪的圆极化天线指向卫星。地面业余电台天线的最佳极化旋转方向为： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在视距通信中，已知发射天线是处于垂直于两台连线的平面内的偶极天线，但极化方向不断变化。能够保证在任何时刻信号都不会因极化问题而中断通信的接收天线极化方式为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 指向发射点、右旋或左旋圆极化
\item 垂直极化
\item 水平极化
...
\noindent\textbf{问题：}下列哪一项描述了一个导线与地球表面平行架设的偶极子天线的性质？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 是水平极化的天线
\item 是地波天线
\item 是菱形天线
...
\noindent\textbf{问题：}已知某天线的增益为3.85 dBd，馈入的功率为10W，其等效全向辐射功率（e.i.r.p）为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 40W
\item 13.85W
\item 38.5W
...
\noindent\textbf{问题：}《中华人民共和国无线电频率划分规定》脚注5.67A 说“使用135.7-137.8kHz频段内频率的业余业务台站，其最大有效辐射功率不得超过1瓦（e.i.r.p.）”。其意思为，该频率的业余电台：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}《中华人民共和国无线电频率划分规定》脚注5.67A 说“使用135.7-137.8kHz频段内频率的业余业务台站，其最大辐射功率不得超过1瓦（e.i.r.p.）”。其意思为，该频率的业余电台：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 实际馈送到发射天线的功率不得超过1瓦除以天线的绝对增益比值Gi后得到的功率值
\item 发射机标称输出功率不得超过1瓦
\item 扣除馈线损耗后实际馈送到发射天线的功率不得超过1瓦
...
\noindent\textbf{问题：}已知某天线的增益为5.15 dBi，馈入的功率为10W，其有效辐射功率（e.r.p）为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 20W
\item 51.5W
\item 10W
...
\noindent\textbf{问题：}在HF远距离通信中，收发信天线周围的大地导电率对辐射效果的影响大致是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在因空间限制、HF偶极天线达不到自然谐振所需长度而必须缩短时，可以在天线电路的某一点串入一个线圈，或者将整个振子做成一个线圈，加以补偿，构成“加感天线”。在充分优化设计的条件下，它们与全尺寸半波长偶极天线相比较的结果是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}行波天线是一种依靠射频电流在长导线组成的连续匹配回路中流动产生辐射的天线，业余通信常用的有T2FD天线和贝伐列奇天线等。与驻波天线相比，行波天线的特点有：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}业余通信常用的T2FD行波天线和贝伐列奇等行波天线都在天线的终端接了一个无感电阻。关于它的作用，正确说法是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}图示为我国业余电台野外通信常见的14MHz/21MHz/29MHz三频段偶极天线原理图。其中各段天线的电气长度应分别为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}图示为我国业余电台野外通信常见的14MHz/21MHz/29MHz三频段偶极天线原理图。其中部件A、B、C、D的作用分别为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item A、D为21MHz陷波器，B、C为28MHz陷波器，即分别谐振于21MHz和28MHz的并联谐振回路
\item A、D为21MHz陷波器，B、C为28MHz陷波器，即分别谐振于21MHz和28MHz的串联谐振回路
\item A、D为14MHz陷波器，B、C为21MHz陷波器，即分别谐振于14MHz和21MHz的并联谐振回路
\item A、D为14MHz陷波器，B、C为21MHz陷波器，即分别谐振于14MHz和21MHz的串联谐振回路
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}水平偶极天线振子的最短理想长度是工作频率的半波长。因条件限制而必须缩短振子时，不得不在天线的某个地方串入额外的电感将振子的自然谐振频率补偿到工作频率，但天线的效率比半波长天线有所降低。图为常用的方案，如果振子（红色部分）总长度相等，各方案的名称以及按发射效率由高到低的排序为： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}垂直GP天线振子的最短理想长度是工作频率的1/4波长。因条件限制而必须缩短振子时，不得不在天线的某个地方串入额外的电感将振子的自然谐振频率补偿到工作频率，但天线的效率比1/4波长天线有所降低。图为常用的方案，如果振子（红色部分）总长度相等，各方案的名称以及按发射效率由高到低的排序为： 
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item C-顶部加感, B-中间加感, A-底部加感
\item A-底部加感, B-中间加感, C-顶部加感
\item A-底部加感, C-顶部加感, B-中间加感
...
\noindent\textbf{问题：}业余和专业无线电通信常用工作于不同频率的多副偶极天线的馈电点并联在一起构成多频段天线。对图示的由7MHz、14MHz和28MHz半波长振子组成的多频段天线的分析为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 7MHz振子可以以3/2波长方式工作于21MHz，可在7/14/21/28MHz四个频段工作；不工作的振子呈现高阻抗，并联后总阻抗为50欧左右
\item 只能工作于7/14/28MHz三个频段。不工作的振子呈现高阻抗；并联后的总阻抗为50欧左右
\item 7MHz振子可以3/2波长方式工作于21MHz，可在7/14/21/28MHz四个频段工作；每个偶极天线的阻抗都是50欧，并联后总阻抗为17欧左右
\item 只能工作于7/14/28MHz三个频段；每个偶极天线的阻抗都是50欧，并联后总阻抗为17欧左右
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}无线电发射设备和市电网的发电机都属于交流电源。接到无线电发射设备的平行导线上可能会出现电压和电流的驻波，造成各处电压不同，而接到市电网上的电线却看不到这种现象。原因是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}一根特性阻抗为50欧的同轴电缆，一端接一个50欧电阻负载，用天线阻抗分析仪测量另一端在某工作频率下的实际阻抗。
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 读数为50欧，与电缆长度无关
...
\noindent\textbf{问题：}一根特性阻抗为50欧的同轴电缆，一端开路，用天线阻抗分析仪测量另一端在某工作频率下的实际阻抗。
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 读数取决于电缆长度，长1/4波长的偶数倍时接近无穷大，1/4波长奇数倍时接近零
\item 读数取决于电缆长度，长1/4波长的奇数倍时接近无穷大，1/4波长偶数倍时接近零
\item 读数取决于负载电阻的额定功率，额定功率越小，读数越大
...
\noindent\textbf{问题：}一根特性阻抗为50欧的同轴电缆，一端芯线和外屏蔽层短路，用天线阻抗分析仪测量另一端在某工作频率下的实际阻抗。
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 读数取决于电缆长度，长1/4波长的奇数倍时接近无穷大，1/4波长偶数倍时接近零
\item 读数取决于电缆长度，长1/4波长的偶数倍时接近无穷大，1/4波长奇数倍时接近零
\item 读数取决于负载电阻的额定功率，额定功率越小，读数越大
...
\noindent\textbf{问题：}用天线阻抗分析仪测量一副失配天线在某工作频率下的实际阻抗，发现配用不同的电缆连接仪器和天线时，得到的读数相差很大。为保证读数准确，可采取以下措施：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}电磁波在电能和磁能相互交换和贮存的过程中向四周传播。影响电磁波辐射场能量的因素有：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}自由空间中甲乙两台相距100公里，均采用增益为0dBi的天线，发射端功率1W，工作频率为145MHz，接收端天线得到的信号功率约为-115.6dBm。如将距离增加为500km，接收到的信号功率将为：【提示：无线电波的自由空间路径损耗为：L=32.4+20logR+20logF，其中R为发射端到接收端的距离（km），F为工作频率（MHz）】
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item -129.6 dBm
\item -101.6 dBm
\item -135.6 dBm
...
\noindent\textbf{问题：}自由空间中甲乙两台相距100公里，均采用增益为0dBi的天线，发射端功率1W，工作频率为145MHz，接收端天线得到的信号功率约为-115.6dBm。如将距离增加为1000km，接收到的信号功率将为：【提示：无线电波的自由空间路径损耗为：L=32.4+20logR+20logF，其中R为发射端到接收端的距离（km），F为工作频率（MHz）】
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item -135.6 dBm
\item -95.6 dBm
\item -129.6 dBm
...
\noindent\textbf{问题：}自由空间中甲乙两台相距100公里，均采用增益为0dBi的天线，发射端功率1W，工作频率为145MHz，接收端天线得到的信号功率约为-115.6dBm。如将频率改为435MHz，接收到的信号功率将约为：【提示：无线电波的自由空间路径损耗为：L=32.4+20logR+20logF，其中R为发射端到接收端的距离（km），F为工作频率（MHz）】
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item -125.1 dBm
\item -109.6 dBm
\item -129.6 dBm
...
\noindent\textbf{问题：}自由空间中甲乙两台相距100公里，均采用增益为0dBi的天线，发射端功率1W，工作频率为145MHz，接收端天线得到的信号功率约为-115.6dBm。如将发射功率减少为0.25W，接收到的信号功率将为：【提示：无线电波的自由空间路径损耗为：L=32.4+20logR+20logF，其中R为发射端到接收端的距离（km），F为工作频率（MHz）】
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item -121.6 dBm
\item -109.6 dBm
\item -129.6 dBm
...
\noindent\textbf{问题：}自由空间中相距100km的甲乙两台通信，工作频率145MHz，接收端的信号强度指示为S8。如将距离增加为500km，接收信号强度指示将变为：【提示：无线电波的自由空间路径损耗为：L=32.4+20logR+20logF，其中R为发射端到接收端的距离（km），F为工作频率（MHz）；收信机信号强度指示S1至S9每挡相差6dB】
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 略低于S6
\item 略高于S6
\item 略低于S5
...
\noindent\textbf{问题：}自由空间中相距100km的甲乙两台通信，工作频率145MHz，接收端的信号强度指示为S8。如将距离增加为1000km，接收信号强度指示将变为：【提示：无线电波的自由空间路径损耗为：L=32.4+20logR+20logF，其中R为发射端到接收端的距离（km），F为工作频率（MHz）；收信机信号强度指示S1至S9每挡相差6dB】
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 略低于S5
\item 略高于S5
\item 略高于S6
...
\noindent\textbf{问题：}自由空间中相距100km的甲乙两台通信，工作频率145MHz，接收端的信号强度指示为S8。如将频率改为435MHz，接收信号强度指示将变为：【提示：无线电波的自由空间路径损耗为：L=32.4+20logR+20logF，其中R为发射端到接收端的距离（km），F为工作频率（MHz）；收信机信号强度指示S1至S9每挡相差6dB】
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 略高于S6
\item 略低于S5
\item 略低于S6
...
\noindent\textbf{问题：}自由空间中相距100km的甲乙两台通信，工作频率为145MHz，接收端的信号强度指示为S8。如将发射功率减少为原来的1/4，接收信号强度指示将变为：【提示：无线电波的自由空间路径损耗为：L=32.4+20logR+20logF，其中R为发射端到接收端的距离（km），F为工作频率（MHz）；收信机信号强度指示S1至S9每档相差6dB】
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item S7
\item 略高于S5
\item 略高于S6
...
\noindent\textbf{问题：}什么叫“理想点源天线”？对业余无线电爱好者有什么意义？	
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}真空中理想点源天线发出的电磁波是一个均匀球面波，任何一个与传播途径垂直的空间截面上的功率通量密度的分布规律为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}自由空间中电磁波随距离而发散减弱的路径损耗为L＝20 lg d + 20 lg f + 32.44（其中损耗L的单位为dB，距离的单位为 km，频率f的单位为MHz）。由此可知，当频率一定时：（“X＾M”表示“X的二次方”）
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}自由空间中电磁波随距离而发散减弱的路径损耗为L＝20 lg d + 20 lg f + 32.44（其中损耗L的单位为dB，距离的单位为 km，频率f的单位为MHz）。由此可知，当距离一定时：（“X＾M”表示“X的二次方”）
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 频率增加到N倍，衰减增大到N＾2倍
\item 频率增加到N倍，衰减增大到N倍
\item 频率增加到N倍，衰减增大到2×N倍
\item 频率增加到N倍，衰减减少到1/N，所以430MHz信号比144MHz强
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}在电磁场理论中，关于“强度随离辐射源距离的平方成反比”的规律适用条件是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}在空旷场地用场强计比较不同型号的辐射仰角为0的全向垂直天线在无线电通信中的实际辐射能力，需要注意：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}80米波段业余无线电测向机多采用环形天线和鞭状天线分别接收信号的磁场和电场分量，组合得到心形图单向特性。但远处调好的方向性，往往在接近电台后变差而需要重新调整鞭状天线的长度。其原因是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}进行短波电离层传播预测所必需的参数为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}对短波电离层传播发生主要影响的各电离层按离子密度自高到低分别为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item F2、F1、E、D
\item A、B、C、D
\item F、E2、E1、D
...
\noindent\textbf{问题：}在业余无线电HF传播预测中，经常遇到缩写为F107的参数，其意义是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 太阳10.7cm波长射电辐射通量指数
\item FM广播频段107MHz的典型传播距离
...
\noindent\textbf{问题：}在业余无线电HF传播预测中，经常遇到缩写为F107的参数，其数值范围大致为60-300。数值越大，其意义为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 宁静太阳的辐射强度越强，电离层密度越大，有利于F层对DX电波的反射
\item 电离层对10.7MHz电波的衰减越大，说明DX传播的条件越差
\item FM广播频段107MHz的典型传播距离越远，可用作300公里以内的VHF传播距离预测
...
\noindent\textbf{问题：}进行传播预测时，太阳通量的值最低可以取为50左右，最高可以取为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 300
\item 280
\item 250
...
%\noindent\textbf{问题：}反映地磁活动的程度有A指数和K指数，K指数是一个0到___之间变化的数字：
\noindent\textbf{问题：}反映地磁活动的程度有A指数和K指数，K指数是一个0到$\_\_\_$之间变化的数字：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 9
\item 8
\item 7
...
\noindent\textbf{问题：}电磁波在地球与电离层间反射后，通常会发生什么？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 信号的极化方向发生随机改变
\item 每一次反射都会使边带倒转
\item 电磁波的频率被随机增加或减少一定的值
\item 频率在30MHz以上的电磁波信号会在每一次反射后变得更强
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}业余电台和业余卫星之间通信，VHF/UHF频段影响信号强度的主要因素是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 无线电波在自由空间的衰减
\item 电离层对无线电波的吸收
\item 电离层对无线电波的反射
...
\noindent\textbf{问题：}业余卫星通信和业余无线电测向都会出现“多普勒效应”的概念。多普勒效应是指：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}地面业余电台进行业余卫星通信时，接收到的卫星信号频率的多普勒频移规律是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}按照频率划分表，122.25—123GHz业余频段不能用于卫星业余业务，但这对业余卫星通信活动影响不大。这是因为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 60GHz、120GHz、183GHz附近存在衰减很大的大气吸收频带，并不适合用作业余卫星通信
\item 120GHz附近频段存在特别强烈的宇宙射线干扰，不适合用作卫星通信
\item 业余无线电爱好者不具备制造工作在120GHz附近频段的设备的能力
\item 120GHz附近频段的天线尺寸太大，不适合用作业余卫星通信
\end{enumerate}
\noindent\textbf{解说：}\textbf{}。\\\noindent\textbf{答案：}
...
\noindent\textbf{问题：}无线电波传播受降雨影响最严重的频段是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 极高频EHF（毫米波）
\item 高频HF（短波）
\item 低频LF（长波）
...
\noindent\textbf{问题：}做EME通信试验最好的时机是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 月亮处于近地点
\item 满月
\item 通信两端天气都好
...
\noindent\textbf{问题：}在10米、6米、2米波段经常能够接收到的“超视距传播”信号与下列哪种传播现象密切相关？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 突发E电离层
\item 流星余迹反向散射
\item D层的吸收
...
\noindent\textbf{问题：}在通常情况下，下列哪种传播模式可能使500公里左右范围的VHF和UHF超视距通信变得可行？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 对流层散射
\item D层折射
\item F2层折射
...
\noindent\textbf{问题：}哪一个业余无线电波段最适合流星余迹散射通信？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 6米
\item 10米
\item 2米
...
\noindent\textbf{问题：}是什么导致了对流层的大气波导传播？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 大气高空逆温
\item 太阳黑子和太阳耀斑
\item 飓风或龙卷风导致的上升气流
...
\noindent\textbf{问题：}用万用电表的直流电压档测量简单正弦交流电压，得到的读数是该电压的：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 零
\item 最大值
\item 峰-峰值
...
\noindent\textbf{问题：}用万用电表的直流电压档测量正负对称的方波电压（占空比为1），得到的读数是该电压的：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 零
\item 最大值
\item 最大值的1/2
...
\noindent\textbf{问题：}用磁电式万用电表的交流电压档测量正负对称的方波电压，其指针指示的电压读数：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 比最大值大
\item 为最大值
\item 为峰-峰值
...
\noindent\textbf{问题：}用万用电表的直流电压档测量最小值为0的方波电压（占空比为1），得到的读数是该电压的：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 最大值的1/2
\item 最大值
\item 最大值的2倍
...
\noindent\textbf{问题：}测量一个电解电容器是否完好，应该使用：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 万用电表的电阻挡
\item 万用电表的电压挡
\item 万用电表的电流挡
...
\noindent\textbf{问题：}用万用电表的电阻档测量一支阻抗为50欧姆的四分之一波长接地天线，读数为0欧。则可以做出如下结论：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}用万用电表的电阻挡测量一支阻抗为50欧姆的四分之一波长接地天线，读数为无穷大。则可以做出如下结论：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}万用电表设在电阻挡，将表笔分别接到一条终端开路的任意长度的50欧同轴电缆的中心导体和屏蔽层，读数应为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 无穷大
\item 50欧姆
\item 0欧姆
...
\noindent\textbf{问题：}用万用电表的电阻挡测量一个常用元件的电阻，在R×1挡、R×10挡和R×100挡测的的读数有很大差别，分别为40欧、240欧和2000欧。正确的推论是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}用指针式万用电表的电阻挡测量一个常用元件，表笔第一次连接时表针挥动了一下，但很快回到零点，断开表笔重新连接，表针却不再有任何指示。正确的推论是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 该元件可能是一个电解电容器
\item 该元件肯定是一只损坏了的电阻
\item 万用表的准确度肯定有问题
...
\noindent\textbf{问题：}万用电表的电压挡有一个“欧姆/伏（每伏欧姆）”的指标。每伏欧姆数越大，说明：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}用万用电表的交流电压档测量电路中某两点间的等幅度音频信号电压，发现交换两支表笔时虽然都有指示，但得到的度数不相同。正确的推论是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
...
\noindent\textbf{问题：}用万用电表的交流电压档测量电路中某两点间的等幅度音频信号电压，得到一个读数，但在交换两支表笔后表针就根本没有偏转了，反复试验都是如此。正确的推论是：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 音频信号上叠加有直流成分，且电表电路采用了半波整流
\item 音频信号上叠加有直流成分，且电表电路采用了全波整流
\item 电表精度太差
...
\noindent\textbf{问题：}哪一种焊锡材料比较适用于无线电制作和修理？
\begin{enumerate}[label=\Alph*), leftmargin=3em]
\item 松香芯焊锡丝
\item 银焊锡丝
\item 酸心焊锡丝
...
\noindent\textbf{问题：}如果用欧姆表测量一个电路，最开始欧姆表显示阻抗很小，接着显示电阻变得越来越大，这是因为：
\begin{enumerate}[label=\Alph*), leftmargin=3em]
